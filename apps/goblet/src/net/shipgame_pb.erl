...
-export([
    enum_symbol_by_value_MatchState/1,
    enum_value_by_symbol_MatchState/1
]).

-export([enum_symbol_by_value_MatchMode/1, enum_value_by_symbol_MatchMode/1]).
-export([
    enum_symbol_by_value_MatchStateMachine/1,
    enum_value_by_symbol_MatchStateMachine/1
]).

-export([
    enum_symbol_by_value_PlayerRole/1,
    enum_value_by_symbol_PlayerRole/1
]).

-export([
    enum_symbol_by_value_ItemAction/1,
    enum_value_by_symbol_ItemAction/1
]).
...
-export([
    'enum_symbol_by_value_PlayerListResp.Status'/1,
    'enum_value_by_symbol_PlayerListResp.Status'/1
]).
...
-type 'PlayerListResp.Status'() :: 'OK' | 'ERROR'.
...
-type 'PlayerListResp'() :: #'PlayerListResp'{}.

-type 'PlayerInfoResp'() :: #'PlayerInfoResp'{}.

-type 'PlayerAuthenticate'() :: #'PlayerAuthenticate'{}.

-type 'ClientLog'() :: #'ClientLog'{}.

-type 'MatchListResp'() :: #'MatchListResp'{}.
...
-type 'MatchDecideReq.Action'() :: #'MatchDecideReq.Action'{}.

-type 'MatchDecideReq'() :: #'MatchDecideReq'{}.

-type 'MatchDecideResp'() :: #'MatchDecideResp'{}.

-type 'MatchIntentResp.Action'() :: #'MatchIntentResp.Action'{}.

-type 'MatchIntentResp'() :: #'MatchIntentResp'{}.

-type 'ShipValidateReq.Component'() :: #'ShipValidateReq.Component'{}.

-type 'ShipValidateReq'() :: #'ShipValidateReq'{}.

-type 'ShipValidateResp'() :: #'ShipValidateResp'{}.
...
-export_type([
    ...
    'MatchInfoReq'/0,
    'MatchInfoResp'/0,
    'MatchStateResp.Tile'/0,
    'MatchStateResp.Action'/0,
    'MatchStateResp'/0,
    'MatchPrepReq'/0,
    'MatchPrepResp'/0,
    'MatchDecideReq.Action'/0,
    'MatchDecideReq'/0,
    'MatchDecideResp'/0,
    'MatchIntentResp.Action'/0,
    'MatchIntentResp'/0,
    'ShipValidateReq.Component'/0,
    'ShipValidateReq'/0,
    'ShipValidateResp'/0
]).
...
-spec encode_msg(
    ...
    | #'MatchPrepReq'{}
    | #'MatchPrepResp'{}
    | #'MatchDecideReq.Action'{}
    | #'MatchDecideReq'{}
    | #'MatchDecideResp'{}
    | #'MatchIntentResp.Action'{}
    | #'MatchIntentResp'{}
    | #'ShipValidateReq.Component'{}
    | #'ShipValidateReq'{}
    | #'ShipValidateResp'{}
) -> binary().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        ...
        'PlayerListResp' ->
            encode_msg_PlayerListResp(
                id(Msg, TrUserData),
                TrUserData
            );
        'PlayerInfoResp' ->
            encode_msg_PlayerInfoResp(
                id(Msg, TrUserData),
                TrUserData
            );
        'PlayerAuthenticate' ->
        ...
        'MatchStartReq' ->
            encode_msg_MatchStartReq(
                id(Msg, TrUserData),
                TrUserData
            );
        'MatchStartResp' ->
            encode_msg_MatchStartResp(
                id(Msg, TrUserData),
                TrUserData
            );
        'MatchInfoReq' ->
            encode_msg_MatchInfoReq(
                id(Msg, TrUserData),
                TrUserData
            );
        'MatchInfoResp' ->
            encode_msg_MatchInfoResp(
                id(Msg, TrUserData),
                TrUserData
            );
        'MatchStateResp.Tile' ->
            'encode_msg_MatchStateResp.Tile'(
                id(Msg, TrUserData),
                TrUserData
            );
        'MatchStateResp.Action' ->
            'encode_msg_MatchStateResp.Action'(
                id(Msg, TrUserData),
                TrUserData
            );
        'MatchStateResp' ->
            encode_msg_MatchStateResp(
                id(Msg, TrUserData),
                TrUserData
            );
        'MatchPrepReq' ->
            encode_msg_MatchPrepReq(
                id(Msg, TrUserData),
                TrUserData
            );
        'MatchPrepResp' ->
            encode_msg_MatchPrepResp(
                id(Msg, TrUserData),
                TrUserData
            );
        'MatchDecideReq.Action' ->
            'encode_msg_MatchDecideReq.Action'(
                id(Msg, TrUserData),
                TrUserData
            );
        'MatchDecideReq' ->
            encode_msg_MatchDecideReq(
                id(Msg, TrUserData),
                TrUserData
            );
        'MatchDecideResp' ->
            encode_msg_MatchDecideResp(
                id(Msg, TrUserData),
                TrUserData
            );
        'MatchIntentResp.Action' ->
            'encode_msg_MatchIntentResp.Action'(
                id(Msg, TrUserData),
                TrUserData
            );
        'MatchIntentResp' ->
            encode_msg_MatchIntentResp(
                id(Msg, TrUserData),
                TrUserData
            );
        'ShipValidateReq.Component' ->
            'encode_msg_ShipValidateReq.Component'(
                id(
                    Msg,
                    TrUserData
                ),
        ...
        'ShipValidateReq' ->
            encode_msg_ShipValidateReq(
                id(Msg, TrUserData),
                TrUserData
            );
        'ShipValidateResp' ->
            encode_msg_ShipValidateResp(
                id(Msg, TrUserData),
                TrUserData
            )
    end.
...
encode_msg_PlayerNewReq(
    ...
    B2 = begin
        ...
        if
            TrF2 == [] -> B1;
            true -> e_field_PlayerNewReq_color(TrF2, B1, TrUserData)
        end
    end,
    B3 = begin
        TrF3 = id(F3, TrUserData),
        if
            TrF3 == [] -> B2;
            true -> e_field_PlayerNewReq_symbol(TrF3, B2, TrUserData)
        end
    end,
    begin
        TrF4 = id(F4, TrUserData),
        e_enum_PlayerRole(TrF4, <<B3/binary, 32>>, TrUserData)
    end.
...
encode_msg_PlayerListResp(Msg, TrUserData) ->
    encode_msg_PlayerListResp(Msg, <<>>, TrUserData).
...
encode_msg_PlayerListResp(
    ...
    B2 = begin
        ...
        if
            TrF2 == [] -> B1;
            true -> e_field_PlayerListResp_players(TrF2, B1, TrUserData)
        end
    end,
    if
        F3 == undefined ->
...
encode_msg_PlayerInfoResp(Msg, TrUserData) ->
    encode_msg_PlayerInfoResp(Msg, <<>>, TrUserData).
...
encode_msg_PlayerInfoResp(
    ...
    B4 = begin
        ...
        if
            TrF4 == [] -> B3;
            true -> e_field_PlayerInfoResp_flags(TrF4, B3, TrUserData)
        end
    end,
    begin
        TrF5 = id(F5, TrUserData),
        if
            TrF5 == [] -> B4;
            true -> e_field_PlayerInfoResp_inventory(TrF5, B4, TrUserData)
        end
    end.
...
encode_msg_MatchListResp(Msg, TrUserData) ->
    encode_msg_MatchListResp(Msg, <<>>, TrUserData).
...
encode_msg_MatchListResp(
    ...
    begin
        ...
        if
            TrF2 == [] -> B1;
            true -> e_field_MatchListResp_matches(TrF2, B1, TrUserData)
        end
    end.
...
encode_msg_MatchCreateReq(
    ...
    B2 = begin
        TrF2 = id(F2, TrUserData),
        e_enum_MatchMode(TrF2, <<B1/binary, 16>>, TrUserData)
    end,
    B3 = begin
        TrF3 = id(F3, TrUserData),
...
encode_msg_MatchStartResp(
    #'MatchStartResp'{resp = F1},
    Bin,
    TrUserData
) ->
    begin
        TrF1 = id(F1, TrUserData),
        e_mfield_MatchStartResp_resp(
            TrF1,
            <<Bin/binary, 10>>,
            TrUserData
        )
    ...
    B4 = begin
        ...
        if
            TrF4 == [] ->
                B3;
            true ->
                'e_field_MatchStateResp.Tile_occupant'(
                    TrF4,
                    B3,
                    TrUserData
                )
    ...
    begin
        ...
        if
            TrF5 == [] ->
                B4;
            true ->
                'e_field_MatchStateResp.Tile_flags'(
                    TrF5,
                    B4,
                    TrUserData
                )
...
encode_msg_MatchStateResp(
    ...
    B2 = begin
        ...
        if
            TrF2 == [] -> B1;
            true -> e_field_MatchStateResp_board(TrF2, B1, TrUserData)
        end
    end,
    B3 = begin
        TrF3 = id(F3, TrUserData),
        if
            TrF3 == [] -> B2;
            true -> e_field_MatchStateResp_playerlist(TrF3, B2, TrUserData)
        end
    end,
    B4 = begin
        TrF4 = id(F4, TrUserData),
        if
            TrF4 == [] ->
                B3;
            true ->
                e_field_MatchStateResp_readyplayers(
                    TrF4,
                    B3,
                    TrUserData
                )
    ...
    B5 = begin
        ...
        if
            TrF5 == [] -> B4;
            true -> e_field_MatchStateResp_replay(TrF5, B4, TrUserData)
        end
    end,
    if
        F6 == undefined ->
...
encode_msg_MatchPrepResp(
    #'MatchPrepResp'{resp = F1},
    Bin,
    TrUserData
) ->
    begin
        TrF1 = id(F1, TrUserData),
        e_mfield_MatchPrepResp_resp(
            TrF1,
            <<Bin/binary, 10>>,
            TrUserData
        )
...
'encode_msg_MatchDecideReq.Action'(Msg, TrUserData) ->
    'encode_msg_MatchDecideReq.Action'(
        Msg,
        <<>>,
        TrUserData
...
encode_msg_MatchDecideReq(
    ...
    B2 = begin
        ...
        if
            TrF2 == [] -> B1;
            true -> e_field_MatchDecideReq_actions(TrF2, B1, TrUserData)
        end
    end,
    begin
        TrF3 = id(F3, TrUserData),
...
'encode_msg_MatchIntentResp.Action'(Msg, TrUserData) ->
    'encode_msg_MatchIntentResp.Action'(
        Msg,
        <<>>,
        TrUserData
...
encode_msg_MatchIntentResp(Msg, TrUserData) ->
    encode_msg_MatchIntentResp(Msg, <<>>, TrUserData).
...
encode_msg_MatchIntentResp(
    ...
    begin
        TrF2 = id(F2, TrUserData),
        e_mfield_MatchIntentResp_action(
            TrF2,
            <<B1/binary, 18>>,
            TrUserData
        )
...
encode_msg_ShipValidateReq(Msg, TrUserData) ->
    encode_msg_ShipValidateReq(Msg, <<>>, TrUserData).
    ...
    begin
        ...
        if
            TrF1 == [] ->
                Bin;
            true ->
                e_field_ShipValidateReq_components(
                    TrF1,
                    Bin,
                    TrUserData
                )
...
encode_msg_ShipValidateResp(Msg, TrUserData) ->
    encode_msg_ShipValidateResp(Msg, <<>>, TrUserData).
...
encode_msg_ShipValidateResp(
    ...
    begin
        TrF1 = id(F1, TrUserData),
        e_mfield_ShipValidateResp_resp(
            TrF1,
            <<Bin/binary, 10>>,
            TrUserData
        )
...
e_field_MatchInfo_players([], Bin, _TrUserData) ->
    Bin.
...
e_field_PlayerNewReq_color(
    ...
    e_field_PlayerNewReq_color(Rest, Bin3, TrUserData);
e_field_PlayerNewReq_color([], Bin, _TrUserData) ->
    Bin.

e_field_PlayerNewReq_symbol(
    [Elem | Rest],
    Bin,
    TrUserData
) ->
    ...
    e_field_PlayerNewReq_symbol(Rest, Bin3, TrUserData);
e_field_PlayerNewReq_symbol([], Bin, _TrUserData) ->
    Bin.

e_field_PlayerListResp_players(
    [Elem | Rest],
    Bin,
    TrUserData
) ->
    ...
    e_field_PlayerListResp_players(Rest, Bin3, TrUserData);
e_field_PlayerListResp_players([], Bin, _TrUserData) ->
    Bin.

e_field_PlayerInfoResp_flags(
    [Elem | Rest],
    Bin,
    TrUserData
) ->
    ...
    e_field_PlayerInfoResp_flags(Rest, Bin3, TrUserData);
e_field_PlayerInfoResp_flags([], Bin, _TrUserData) ->
    Bin.

e_field_PlayerInfoResp_inventory(
    [Elem | Rest],
    Bin,
    TrUserData
) ->
...
e_mfield_MatchListResp_resp(Msg, Bin, TrUserData) ->
...
e_mfield_MatchListResp_matches(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_MatchInfo(Msg, <<>>, TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_MatchListResp_matches(
    [Elem | Rest],
    Bin,
    TrUserData
) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 = e_mfield_MatchListResp_matches(
        id(
            Elem,
            TrUserData
        ),
    ...
    e_field_MatchListResp_matches(Rest, Bin3, TrUserData);
e_field_MatchListResp_matches([], Bin, _TrUserData) ->
    Bin.
...
e_mfield_MatchStateResp_board(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_MatchStateResp.Tile'(
        Msg,
        <<>>,
        TrUserData
    ),
...
e_field_MatchStateResp_board(
    [Elem | Rest],
    Bin,
    TrUserData
) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 = e_mfield_MatchStateResp_board(
        id(
            Elem,
            TrUserData
        ),
    ...
    e_field_MatchStateResp_board(Rest, Bin3, TrUserData);
e_field_MatchStateResp_board([], Bin, _TrUserData) ->
    Bin.

e_field_MatchStateResp_playerlist(
    [Elem | Rest],
    Bin,
    TrUserData
) ->
...
e_mfield_MatchStateResp_replay(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_MatchStateResp.Action'(
        Msg,
        <<>>,
        TrUserData
    ),
...
e_field_MatchStateResp_replay(
    [Elem | Rest],
    Bin,
    TrUserData
) ->
    Bin2 = <<Bin/binary, 42>>,
    Bin3 = e_mfield_MatchStateResp_replay(
        id(
            Elem,
            TrUserData
        ),
    ...
    e_field_MatchStateResp_replay(Rest, Bin3, TrUserData);
e_field_MatchStateResp_replay([], Bin, _TrUserData) ->
    Bin.
...
e_mfield_MatchDecideReq_actions(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_MatchDecideReq.Action'(
        Msg,
        <<>>,
        TrUserData
    ),
...
e_field_MatchDecideReq_actions(
    [Elem | Rest],
    Bin,
    TrUserData
) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 = e_mfield_MatchDecideReq_actions(
        id(
            Elem,
            TrUserData
        ),
    ...
    e_field_MatchDecideReq_actions(Rest, Bin3, TrUserData);
e_field_MatchDecideReq_actions([], Bin, _TrUserData) ->
    Bin.
...
e_mfield_MatchIntentResp_action(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_MatchIntentResp.Action'(
        Msg,
        <<>>,
        TrUserData
    ),
...
e_mfield_ShipValidateReq_components(
    Msg,
    Bin,
    TrUserData
) ->
    SubBin = 'encode_msg_ShipValidateReq.Component'(
        Msg,
        <<>>,
        TrUserData
    ),
...
e_field_ShipValidateReq_components(
    ...
    Bin2 = <<Bin/binary, 10>>,
    Bin3 = e_mfield_ShipValidateReq_components(
        id(
            Elem,
            TrUserData
        ),
...
e_mfield_ShipValidateResp_resp(Msg, Bin, TrUserData) ->
    SubBin = encode_msg_ResponseObject(
        Msg,
        <<>>,
        TrUserData
...
'e_enum_PlayerListResp.Status'(
    ...
    <<Bin/binary, 1>>;
'e_enum_PlayerListResp.Status'(V, Bin, _TrUserData) ->
    e_varint(V, Bin).
...
decode_msg_2_doit('PlayerListResp', Bin, TrUserData) ->
    id(
        decode_msg_PlayerListResp(Bin, TrUserData),
        TrUserData
    );
decode_msg_2_doit('PlayerInfoResp', Bin, TrUserData) ->
    id(
        decode_msg_PlayerInfoResp(Bin, TrUserData),
        TrUserData
    );
decode_msg_2_doit(
    'PlayerAuthenticate',
...
decode_msg_2_doit('MatchListResp', Bin, TrUserData) ->
    id(
        decode_msg_MatchListResp(Bin, TrUserData),
        TrUserData
    );
...
decode_msg_2_doit(
    ...
    id(
        'decode_msg_MatchDecideReq.Action'(Bin, TrUserData),
        TrUserData
    );
...
decode_msg_2_doit(
    ...
    id(
        'decode_msg_MatchIntentResp.Action'(Bin, TrUserData),
        TrUserData
    );
decode_msg_2_doit('MatchIntentResp', Bin, TrUserData) ->
    id(
        decode_msg_MatchIntentResp(Bin, TrUserData),
        TrUserData
    );
decode_msg_2_doit(
    'ShipValidateReq.Component',
    ...
    id(
        'decode_msg_ShipValidateReq.Component'(
            Bin,
            TrUserData
        ),
        TrUserData
    );
decode_msg_2_doit('ShipValidateReq', Bin, TrUserData) ->
    id(
        decode_msg_ShipValidateReq(Bin, TrUserData),
        TrUserData
    );
decode_msg_2_doit(
    'ShipValidateResp',
    ...
    id(
        decode_msg_ShipValidateResp(Bin, TrUserData),
        TrUserData
    ).
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_MatchInfo(
                        Rest,
                        0,
                        0,
                        F@_1,
...
dfp_read_field_def_PlayerNewReq(
    ...
    #'PlayerNewReq'{
        ...
        symbol = lists_reverse(R2, TrUserData),
        role = F@_4
    };
dfp_read_field_def_PlayerNewReq(
    Other,
...
d_pfield_PlayerNewReq_symbol(
    ...
    NewSeq = d_packed_field_PlayerNewReq_symbol(
        PackedBytes,
        0,
        0,
        E,
...
d_packed_field_PlayerNewReq_symbol(
    <<1:1, X:7, Rest/binary>>,
    N,
    Acc,
    AccSeq,
...
decode_msg_PlayerListResp(Bin, TrUserData) ->
    dfp_read_field_def_PlayerListResp(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
dfp_read_field_def_PlayerListResp(
    ...
    d_field_PlayerListResp_players(
        Rest,
        Z1,
        Z2,
        F@_1,
...
dfp_read_field_def_PlayerListResp(
    ...
    dg_read_field_def_PlayerListResp(
        Other,
        Z1,
        Z2,
        F@_1,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_PlayerListResp(
                        Rest,
                        0,
                        0,
                        F@_1,
...
d_field_PlayerListResp_status(
    ...
    {NewFValue, RestF} =
        {id(
                'd_enum_PlayerListResp.Status'(begin
                    <<Res:32/signed-native>> =
                        <<(X bsl
                                N +
                                Acc):32/unsigned-native>>,
...
decode_msg_PlayerInfoResp(Bin, TrUserData) ->
    dfp_read_field_def_PlayerInfoResp(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
dfp_read_field_def_PlayerInfoResp(
    ...
    d_field_PlayerInfoResp_inventory(
        Rest,
        Z1,
        Z2,
        F@_1,
...
dfp_read_field_def_PlayerInfoResp(
    ...
    #'PlayerInfoResp'{
        ...
        health = F@_2,
        energy = F@_3,
        flags = lists_reverse(R1, TrUserData),
        inventory = lists_reverse(R2, TrUserData)
    };
dfp_read_field_def_PlayerInfoResp(
    Other,
    Z1,
    ...
    dg_read_field_def_PlayerInfoResp(
        Other,
        Z1,
        Z2,
        F@_1,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_PlayerInfoResp(
                        Rest,
                        0,
                        0,
                        F@_1,
...
decode_msg_MatchListResp(Bin, TrUserData) ->
    dfp_read_field_def_MatchListResp(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
dfp_read_field_def_MatchListResp(
    ...
    dg_read_field_def_MatchListResp(
        Other,
        Z1,
        Z2,
        F@_1,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_MatchListResp(
                        Rest,
                        0,
                        0,
                        F@_1,
...
d_field_MatchListResp_matches(
    ...
    {NewFValue, RestF} = begin
        ...
        <<Bs:Len/binary, Rest2/binary>> = Rest,
        {id(
                decode_msg_MatchInfo(Bs, TrUserData),
                TrUserData
            ),
            Rest2}
    end,
...
decode_msg_MatchStartReq(Bin, TrUserData) ->
    dfp_read_field_def_MatchStartReq(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
dfp_read_field_def_MatchStartReq(
    ...
    dg_read_field_def_MatchStartReq(
        Other,
        Z1,
        Z2,
        F@_1,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_MatchStartReq(
                        Rest,
                        0,
                        0,
                        F@_1,
...
decode_msg_MatchStartResp(Bin, TrUserData) ->
    dfp_read_field_def_MatchStartResp(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
dfp_read_field_def_MatchStartResp(
    ...
    dg_read_field_def_MatchStartResp(
        Other,
        Z1,
        Z2,
        F@_1,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_MatchStartResp(
                        Rest,
                        0,
                        0,
                        F@_1,
...
decode_msg_MatchInfoReq(Bin, TrUserData) ->
    dfp_read_field_def_MatchInfoReq(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
dfp_read_field_def_MatchInfoReq(
    ...
    dg_read_field_def_MatchInfoReq(
        Other,
        Z1,
        Z2,
        F@_1,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_MatchInfoReq(
                        Rest,
                        0,
                        0,
                        F@_1,
...
decode_msg_MatchInfoResp(Bin, TrUserData) ->
    dfp_read_field_def_MatchInfoResp(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
dfp_read_field_def_MatchInfoResp(
    ...
    dg_read_field_def_MatchInfoResp(
        Other,
        Z1,
        Z2,
        F@_1,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_MatchInfoResp(
                        Rest,
                        0,
                        0,
                        F@_1,
...
'decode_msg_MatchStateResp.Tile'(Bin, TrUserData) ->
    'dfp_read_field_def_MatchStateResp.Tile'(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
'dfp_read_field_def_MatchStateResp.Tile'(
    ...
    'd_field_MatchStateResp.Tile_type'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_MatchStateResp.Tile'(
    ...
    'd_field_MatchStateResp.Tile_occupant'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_MatchStateResp.Tile'(
    ...
    'd_field_MatchStateResp.Tile_flags'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_MatchStateResp.Tile'(
    ...
    'dg_read_field_def_MatchStateResp.Tile'(
        Other,
        Z1,
        Z2,
        F@_1,
...
'dg_read_field_def_MatchStateResp.Tile'(
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    'skip_varint_MatchStateResp.Tile'(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                2 ->
                    'skip_length_delimited_MatchStateResp.Tile'(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                3 ->
                    'skip_group_MatchStateResp.Tile'(
                        Rest,
                        Key bsr 3,
                        0,
                        F@_1,
...
'decode_msg_MatchStateResp.Action'(Bin, TrUserData) ->
    'dfp_read_field_def_MatchStateResp.Action'(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
'dfp_read_field_def_MatchStateResp.Action'(
    ...
    'd_field_MatchStateResp.Action_type'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_MatchStateResp.Action'(
    ...
    'd_field_MatchStateResp.Action_who'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_MatchStateResp.Action'(
    ...
    'd_field_MatchStateResp.Action_x'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_MatchStateResp.Action'(
    ...
    'd_field_MatchStateResp.Action_y'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_MatchStateResp.Action'(
    ...
    'dg_read_field_def_MatchStateResp.Action'(
        Other,
        Z1,
        Z2,
        F@_1,
...
'dg_read_field_def_MatchStateResp.Action'(
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    'skip_varint_MatchStateResp.Action'(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                2 ->
                    'skip_length_delimited_MatchStateResp.Action'(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                3 ->
                    'skip_group_MatchStateResp.Action'(
                        Rest,
                        Key bsr 3,
                        0,
                        F@_1,
...
decode_msg_MatchStateResp(Bin, TrUserData) ->
    dfp_read_field_def_MatchStateResp(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
dfp_read_field_def_MatchStateResp(
    ...
    d_field_MatchStateResp_playerlist(
        Rest,
        Z1,
        Z2,
        F@_1,
...
dfp_read_field_def_MatchStateResp(
    ...
    d_field_MatchStateResp_readyplayers(
        Rest,
        Z1,
        Z2,
        F@_1,
...
dfp_read_field_def_MatchStateResp(
    ...
    dg_read_field_def_MatchStateResp(
        Other,
        Z1,
        Z2,
        F@_1,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_MatchStateResp(
                        Rest,
                        0,
                        0,
                        F@_1,
...
d_field_MatchStateResp_state(
    ...
    {NewFValue, RestF} =
        {id(
                d_enum_MatchStateMachine(begin
                    <<Res:32/signed-native>> =
                        <<(X bsl N +
                                Acc):32/unsigned-native>>,
                    id(Res, TrUserData)
...
d_field_MatchStateResp_board(
    ...
    {NewFValue, RestF} = begin
        ...
        <<Bs:Len/binary, Rest2/binary>> = Rest,
        {id(
                'decode_msg_MatchStateResp.Tile'(
                    Bs,
                    TrUserData
                ),
                TrUserData
...
d_field_MatchStateResp_replay(
    ...
    {NewFValue, RestF} = begin
        ...
        <<Bs:Len/binary, Rest2/binary>> = Rest,
        {id(
                'decode_msg_MatchStateResp.Action'(
                    Bs,
                    TrUserData
                ),
                TrUserData
...
decode_msg_MatchPrepReq(Bin, TrUserData) ->
    dfp_read_field_def_MatchPrepReq(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
dfp_read_field_def_MatchPrepReq(
    ...
    dg_read_field_def_MatchPrepReq(
        Other,
        Z1,
        Z2,
        F@_1,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_MatchPrepReq(
                        Rest,
                        0,
                        0,
                        F@_1,
...
decode_msg_MatchPrepResp(Bin, TrUserData) ->
    dfp_read_field_def_MatchPrepResp(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
dfp_read_field_def_MatchPrepResp(
    ...
    dg_read_field_def_MatchPrepResp(
        Other,
        Z1,
        Z2,
        F@_1,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_MatchPrepResp(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                5 ->
                    skip_32_MatchPrepResp(Rest, 0, 0, F@_1, TrUserData)
            end
    end;
...
'decode_msg_MatchDecideReq.Action'(Bin, TrUserData) ->
    'dfp_read_field_def_MatchDecideReq.Action'(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
'dfp_read_field_def_MatchDecideReq.Action'(
    ...
    'd_field_MatchDecideReq.Action_item'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_MatchDecideReq.Action'(
    ...
    'd_field_MatchDecideReq.Action_x'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_MatchDecideReq.Action'(
    ...
    'd_field_MatchDecideReq.Action_y'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_MatchDecideReq.Action'(
    ...
    'd_field_MatchDecideReq.Action_target'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_MatchDecideReq.Action'(
    ...
    'dg_read_field_def_MatchDecideReq.Action'(
        Other,
        Z1,
        Z2,
        F@_1,
...
'dg_read_field_def_MatchDecideReq.Action'(
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    'skip_varint_MatchDecideReq.Action'(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                2 ->
                    'skip_length_delimited_MatchDecideReq.Action'(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                3 ->
                    'skip_group_MatchDecideReq.Action'(
                        Rest,
                        Key bsr 3,
                        0,
                        F@_1,
...
decode_msg_MatchDecideReq(Bin, TrUserData) ->
    dfp_read_field_def_MatchDecideReq(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
dfp_read_field_def_MatchDecideReq(
    ...
    d_field_MatchDecideReq_actions(
        Rest,
        Z1,
        Z2,
        F@_1,
...
dfp_read_field_def_MatchDecideReq(
    ...
    d_field_MatchDecideReq_matchid(
        Rest,
        Z1,
        Z2,
        F@_1,
...
dfp_read_field_def_MatchDecideReq(
    ...
    #'MatchDecideReq'{
        player = F@_1,
        actions = lists_reverse(R1, TrUserData),
        matchid = F@_3
    };
dfp_read_field_def_MatchDecideReq(
    Other,
    ...
    dg_read_field_def_MatchDecideReq(
        Other,
        Z1,
        Z2,
        F@_1,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_MatchDecideReq(
                        Rest,
                        0,
                        0,
                        F@_1,
...
d_field_MatchDecideReq_actions(
    ...
    {NewFValue, RestF} = begin
        ...
        <<Bs:Len/binary, Rest2/binary>> = Rest,
        {id(
                'decode_msg_MatchDecideReq.Action'(
                    Bs,
                    TrUserData
                ),
                TrUserData
...
decode_msg_MatchDecideResp(Bin, TrUserData) ->
    dfp_read_field_def_MatchDecideResp(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
dfp_read_field_def_MatchDecideResp(
    ...
    dg_read_field_def_MatchDecideResp(
        Other,
        Z1,
        Z2,
        F@_1,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_MatchDecideResp(
                        Rest,
                        0,
                        0,
                        F@_1,
...
'decode_msg_MatchIntentResp.Action'(Bin, TrUserData) ->
    'dfp_read_field_def_MatchIntentResp.Action'(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
'dfp_read_field_def_MatchIntentResp.Action'(
    ...
    'd_field_MatchIntentResp.Action_type'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_MatchIntentResp.Action'(
    ...
    'd_field_MatchIntentResp.Action_x'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_MatchIntentResp.Action'(
    ...
    'd_field_MatchIntentResp.Action_y'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_MatchIntentResp.Action'(
    ...
    'd_field_MatchIntentResp.Action_target'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_MatchIntentResp.Action'(
    ...
    'dg_read_field_def_MatchIntentResp.Action'(
        Other,
        Z1,
        Z2,
        F@_1,
...
'dg_read_field_def_MatchIntentResp.Action'(
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    'skip_varint_MatchIntentResp.Action'(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                1 ->
                    'skip_64_MatchIntentResp.Action'(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                2 ->
                    'skip_length_delimited_MatchIntentResp.Action'(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                3 ->
                    'skip_group_MatchIntentResp.Action'(
                        Rest,
                        Key bsr 3,
                        0,
                        F@_1,
                ...
                5 ->
                    'skip_32_MatchIntentResp.Action'(
                        Rest,
                        0,
                        0,
                        F@_1,
...
decode_msg_MatchIntentResp(Bin, TrUserData) ->
    dfp_read_field_def_MatchIntentResp(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
dfp_read_field_def_MatchIntentResp(
    ...
    d_field_MatchIntentResp_player(
        Rest,
        Z1,
        Z2,
        F@_1,
...
dfp_read_field_def_MatchIntentResp(
    ...
    d_field_MatchIntentResp_action(
        Rest,
        Z1,
        Z2,
        F@_1,
...
dfp_read_field_def_MatchIntentResp(
    ...
    #'MatchIntentResp'{player = F@_1, action = F@_2};
dfp_read_field_def_MatchIntentResp(
    Other,
    Z1,
    Z2,
    ...
    dg_read_field_def_MatchIntentResp(
        Other,
        Z1,
        Z2,
        F@_1,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_MatchIntentResp(
                        Rest,
                        0,
                        0,
                        F@_1,
...
d_field_MatchIntentResp_action(
    ...
    {NewFValue, RestF} = begin
        ...
        <<Bs:Len/binary, Rest2/binary>> = Rest,
        {id(
                'decode_msg_MatchIntentResp.Action'(
                    Bs,
                    TrUserData
                ),
                TrUserData
    ...
    dfp_read_field_def_MatchIntentResp(
        ...
        if
            Prev == undefined ->
                NewFValue;
            true ->
                'merge_msg_MatchIntentResp.Action'(
                    Prev,
                    NewFValue,
                    TrUserData
                )
...
'decode_msg_ShipValidateReq.Component'(
    ...
    'dfp_read_field_def_ShipValidateReq.Component'(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
'dfp_read_field_def_ShipValidateReq.Component'(
    ...
    'd_field_ShipValidateReq.Component_x'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_ShipValidateReq.Component'(
    ...
    'd_field_ShipValidateReq.Component_y'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_ShipValidateReq.Component'(
    ...
    'd_field_ShipValidateReq.Component_id'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_ShipValidateReq.Component'(
    ...
    'd_field_ShipValidateReq.Component_rotation'(
        Rest,
        Z1,
        Z2,
        F@_1,
...
'dfp_read_field_def_ShipValidateReq.Component'(
    ...
    'dg_read_field_def_ShipValidateReq.Component'(
        Other,
        Z1,
        Z2,
        F@_1,
...
'dg_read_field_def_ShipValidateReq.Component'(
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    'skip_varint_ShipValidateReq.Component'(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                1 ->
                    'skip_64_ShipValidateReq.Component'(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                2 ->
                    'skip_length_delimited_ShipValidateReq.Component'(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                3 ->
                    'skip_group_ShipValidateReq.Component'(
                        Rest,
                        Key bsr 3,
                        0,
                        F@_1,
                ...
                5 ->
                    'skip_32_ShipValidateReq.Component'(
                        Rest,
                        0,
                        0,
                        F@_1,
...
decode_msg_ShipValidateReq(Bin, TrUserData) ->
    dfp_read_field_def_ShipValidateReq(
        Bin,
        0,
        0,
        id([], TrUserData),
...
dfp_read_field_def_ShipValidateReq(
    ...
    d_field_ShipValidateReq_components(
        Rest,
        Z1,
        Z2,
        F@_1,
...
dfp_read_field_def_ShipValidateReq(
    ...
    dg_read_field_def_ShipValidateReq(
        Other,
        Z1,
        Z2,
        F@_1,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                1 ->
                    skip_64_ShipValidateReq(Rest, 0, 0, F@_1, TrUserData);
                2 ->
                    skip_length_delimited_ShipValidateReq(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                5 ->
                    skip_32_ShipValidateReq(Rest, 0, 0, F@_1, TrUserData)
            end
    end;
dg_read_field_def_ShipValidateReq(
    <<>>,
...
decode_msg_ShipValidateResp(Bin, TrUserData) ->
    dfp_read_field_def_ShipValidateResp(
        Bin,
        0,
        0,
        id(undefined, TrUserData),
...
dfp_read_field_def_ShipValidateResp(
    ...
    dg_read_field_def_ShipValidateResp(
        Other,
        Z1,
        Z2,
        F@_1,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                1 ->
                    skip_64_ShipValidateResp(Rest, 0, 0, F@_1, TrUserData);
                2 ->
                    skip_length_delimited_ShipValidateResp(
                        Rest,
                        0,
                        0,
                        F@_1,
                ...
                5 ->
                    skip_32_ShipValidateResp(Rest, 0, 0, F@_1, TrUserData)
            end
    end;
dg_read_field_def_ShipValidateResp(
    <<>>,
...
'd_enum_PlayerListResp.Status'(0) -> 'OK';
'd_enum_PlayerListResp.Status'(1) -> 'ERROR';
'd_enum_PlayerListResp.Status'(V) -> V.
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
        ...
        'PlayerListResp' ->
            merge_msg_PlayerListResp(Prev, New, TrUserData);
        'PlayerInfoResp' ->
            merge_msg_PlayerInfoResp(Prev, New, TrUserData);
        'PlayerAuthenticate' ->
            merge_msg_PlayerAuthenticate(Prev, New, TrUserData);
        'ClientLog' ->
            merge_msg_ClientLog(Prev, New, TrUserData);
        'MatchListResp' ->
            merge_msg_MatchListResp(Prev, New, TrUserData);
        'MatchCreateReq' ->
        ...
        'MatchStateResp.Action' ->
            'merge_msg_MatchStateResp.Action'(
                Prev,
                New,
                TrUserData
            );
        ...
        'MatchDecideReq.Action' ->
            'merge_msg_MatchDecideReq.Action'(
                Prev,
                New,
                TrUserData
            );
        ...
        'MatchIntentResp' ->
            merge_msg_MatchIntentResp(Prev, New, TrUserData);
        'ShipValidateReq.Component' ->
            'merge_msg_ShipValidateReq.Component'(
                Prev,
                New,
                TrUserData
            );
        'ShipValidateReq' ->
            merge_msg_ShipValidateReq(Prev, New, TrUserData);
        'ShipValidateResp' ->
            merge_msg_ShipValidateResp(Prev, New, TrUserData)
    end.
...
merge_msg_PlayerNewReq(
    ...
    #'PlayerNewReq'{
        ...
        color =
            if
                PFcolor /= undefined, NFcolor /= undefined ->
                    'erlang_++'(PFcolor, NFcolor, TrUserData);
                PFcolor == undefined ->
                    NFcolor;
                NFcolor == undefined ->
                    PFcolor
        ...
        symbol =
            if
                PFsymbol /= undefined, NFsymbol /= undefined ->
                    'erlang_++'(PFsymbol, NFsymbol, TrUserData);
                PFsymbol == undefined ->
                    NFsymbol;
                NFsymbol == undefined ->
                    PFsymbol
...
-compile({nowarn_unused_function, merge_msg_PlayerListResp/3}).

merge_msg_PlayerListResp(
    #'PlayerListResp'{
        players =
            PFplayers,
        error = PFerror
...
-compile({nowarn_unused_function, merge_msg_PlayerInfoResp/3}).

merge_msg_PlayerInfoResp(
    #'PlayerInfoResp'{
        flags =
            PFflags,
        inventory = PFinventory
    },
    #'PlayerInfoResp'{
        name = NFname,
        health = NFhealth,
    ...
    #'PlayerInfoResp'{
        ...
        flags =
            if
                PFflags /= undefined, NFflags /= undefined ->
        ...
        inventory =
            if
                PFinventory /= undefined, NFinventory /= undefined ->
                    'erlang_++'(
                        PFinventory,
                        NFinventory,
                        TrUserData
                    );
                PFinventory == undefined ->
                    NFinventory;
                NFinventory == undefined ->
                    PFinventory
            end
    }.
...
-compile({nowarn_unused_function, merge_msg_MatchListResp/3}).

merge_msg_MatchListResp(
    #'MatchListResp'{
        resp = PFresp,
        matches = PFmatches
    },
    #'MatchListResp'{resp = NFresp, matches = NFmatches},
    TrUserData
) ->
    #'MatchListResp'{
        resp =
...
merge_msg_MatchStartResp(
    #'MatchStartResp'{
        resp =
            PFresp
    },
    #'MatchStartResp'{resp = NFresp},
    TrUserData
) ->
    #'MatchStartResp'{
        resp =
...
'merge_msg_MatchStateResp.Tile'(
    ...
    #'MatchStateResp.Tile'{
        ...
        occupant =
            if
                PFoccupant /= undefined, NFoccupant /= undefined ->
                    'erlang_++'(
                        PFoccupant,
                        NFoccupant,
                        TrUserData
                    );
                PFoccupant == undefined ->
                    NFoccupant;
...
merge_msg_MatchStateResp(
    ...
    #'MatchStateResp'{
        ...
        board =
            if
                PFboard /= undefined, NFboard /= undefined ->
                    'erlang_++'(PFboard, NFboard, TrUserData);
                PFboard == undefined ->
                    NFboard;
                NFboard == undefined ->
                    PFboard
        ...
        playerlist =
            if
                PFplayerlist /= undefined, NFplayerlist /= undefined ->
                    'erlang_++'(
                        PFplayerlist,
                        NFplayerlist,
                        TrUserData
                    );
                PFplayerlist == undefined ->
                    NFplayerlist;
        ...
        readyplayers =
            if
                PFreadyplayers /= undefined, NFreadyplayers /= undefined ->
                    'erlang_++'(
                        PFreadyplayers,
                        NFreadyplayers,
                        TrUserData
                    );
                PFreadyplayers == undefined ->
                    NFreadyplayers;
        ...
        replay =
            if
                PFreplay /= undefined, NFreplay /= undefined ->
                    'erlang_++'(PFreplay, NFreplay, TrUserData);
                PFreplay == undefined ->
                    NFreplay;
                NFreplay == undefined ->
                    PFreplay
...
merge_msg_MatchPrepResp(
    #'MatchPrepResp'{resp = PFresp},
    #'MatchPrepResp'{resp = NFresp},
    TrUserData
) ->
    #'MatchPrepResp'{
        resp =
...
-compile({nowarn_unused_function, 'merge_msg_MatchDecideReq.Action'/3}).
...
merge_msg_MatchDecideReq(
    ...
    #'MatchDecideReq'{
        ...
        actions =
            if
                PFactions /= undefined, NFactions /= undefined ->
...
merge_msg_MatchDecideResp(
    #'MatchDecideResp'{
        resp =
            PFresp
    },
    #'MatchDecideResp'{resp = NFresp},
    TrUserData
) ->
    #'MatchDecideResp'{
        resp =
...
-compile({nowarn_unused_function, 'merge_msg_MatchIntentResp.Action'/3}).
...
-compile({nowarn_unused_function, merge_msg_MatchIntentResp/3}).

merge_msg_MatchIntentResp(
    #'MatchIntentResp'{
        action =
            PFaction
    },
...
-compile({nowarn_unused_function, 'merge_msg_ShipValidateReq.Component'/3}).
...
-compile({nowarn_unused_function, merge_msg_ShipValidateReq/3}).

merge_msg_ShipValidateReq(
    #'ShipValidateReq'{
        components =
            PFcomponents
    },
    #'ShipValidateReq'{components = NFcomponents},
    TrUserData
) ->
    #'ShipValidateReq'{
        components =
            if
                PFcomponents /= undefined, NFcomponents /= undefined ->
                    'erlang_++'(
                        PFcomponents,
                        NFcomponents,
                        TrUserData
                    );
                PFcomponents == undefined ->
                    NFcomponents;
                NFcomponents == undefined ->
                    PFcomponents
            end
    }.

-compile({nowarn_unused_function, merge_msg_ShipValidateResp/3}).

merge_msg_ShipValidateResp(
    #'ShipValidateResp'{
        resp =
            PFresp
    },
    #'ShipValidateResp'{resp = NFresp},
    TrUserData
) ->
    #'ShipValidateResp'{
        resp =
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        ...
        'PlayerListResp' ->
            v_msg_PlayerListResp(Msg, [MsgName], TrUserData);
        'PlayerInfoResp' ->
            v_msg_PlayerInfoResp(Msg, [MsgName], TrUserData);
        'PlayerAuthenticate' ->
            v_msg_PlayerAuthenticate(Msg, [MsgName], TrUserData);
        'ClientLog' ->
            v_msg_ClientLog(Msg, [MsgName], TrUserData);
        'MatchListResp' ->
            v_msg_MatchListResp(Msg, [MsgName], TrUserData);
        'MatchCreateReq' ->
        ...
        'MatchIntentResp.Action' ->
            'v_msg_MatchIntentResp.Action'(
                Msg,
                [MsgName],
                TrUserData
            );
        'MatchIntentResp' ->
            v_msg_MatchIntentResp(Msg, [MsgName], TrUserData);
        'ShipValidateReq.Component' ->
            'v_msg_ShipValidateReq.Component'(
                Msg,
                [MsgName],
                TrUserData
            );
        'ShipValidateReq' ->
            v_msg_ShipValidateReq(Msg, [MsgName], TrUserData);
        'ShipValidateResp' ->
            v_msg_ShipValidateResp(Msg, [MsgName], TrUserData);
        _ ->
...
v_msg_MatchInfo(
    ...
    if
        is_list(F3) ->
            _ = [
                v_type_string(Elem, [players | Path], TrUserData)
                || Elem <- F3
            ],
            ok;
        true ->
...
v_msg_PlayerNewReq(
    ...
    if
        is_list(F2) ->
            _ = [
                v_type_string(Elem, [color | Path], TrUserData)
                || Elem <- F2
            ],
            ok;
        true ->
    ...
    if
        is_list(F3) ->
            _ = [
                v_type_uint32(Elem, [symbol | Path], TrUserData)
                || Elem <- F3
            ],
            ok;
        true ->
            mk_type_error(
                {invalid_list_of, uint32},
                F3,
                [symbol | Path]
            )
    end,
    v_enum_PlayerRole(F4, [role | Path], TrUserData),
    ok;
...
-compile({nowarn_unused_function, v_msg_PlayerListResp/3}).

-dialyzer({nowarn_function, v_msg_PlayerListResp/3}).

v_msg_PlayerListResp(
    #'PlayerListResp'{
        status = F1,
        players = F2,
        error = F3
    ...
    ok;
v_msg_PlayerListResp(X, Path, _TrUserData) ->
    mk_type_error(
        {expected_msg, 'PlayerListResp'},
        X,
        Path
    ).

-compile({nowarn_unused_function, v_msg_PlayerInfoResp/3}).

-dialyzer({nowarn_function, v_msg_PlayerInfoResp/3}).

v_msg_PlayerInfoResp(
    #'PlayerInfoResp'{
        name = F1,
        health = F2,
        energy = F3,
    ...
    v_type_string(F1, [name | Path], TrUserData),
    v_type_int32(F2, [health | Path], TrUserData),
    v_type_int32(F3, [energy | Path], TrUserData),
    if
        is_list(F4) ->
            _ = [
                v_type_string(Elem, [flags | Path], TrUserData)
                || Elem <- F4
            ],
            ok;
        true ->
    ...
    if
        is_list(F5) ->
            _ = [
                v_type_string(Elem, [inventory | Path], TrUserData)
                || Elem <- F5
            ],
            ok;
        true ->
    ...
    ok;
v_msg_PlayerInfoResp(X, Path, _TrUserData) ->
    mk_type_error(
        {expected_msg, 'PlayerInfoResp'},
        X,
        Path
    ).
...
-compile({nowarn_unused_function, v_msg_MatchListResp/3}).

-dialyzer({nowarn_function, v_msg_MatchListResp/3}).
...
v_msg_MatchListResp(
    ...
    if
        is_list(F2) ->
            _ = [
                v_msg_MatchInfo(Elem, [matches | Path], TrUserData)
                || Elem <- F2
            ],
            ok;
        true ->
            mk_type_error(
                {invalid_list_of, {msg, 'MatchInfo'}},
                F2,
                [matches | Path]
            )
    end,
    ok;
v_msg_MatchListResp(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'MatchListResp'}, X, Path).
...
v_msg_MatchCreateReq(
    ...
    v_enum_MatchMode(F2, [mode | Path], TrUserData),
    v_type_uint32(F3, [players_max | Path], TrUserData),
    if
        F4 == undefined -> ok;
        true -> v_type_bytes(F4, [extra | Path], TrUserData)
    end,
    ok;
...
'v_msg_MatchStateResp.Tile'(
    ...
    if
        is_list(F4) ->
            _ = [
                v_type_string(Elem, [occupant | Path], TrUserData)
                || Elem <- F4
            ],
            ok;
        true ->
...
'v_msg_MatchStateResp.Tile'(X, Path, _TrUserData) ->
    mk_type_error(
        {expected_msg, 'MatchStateResp.Tile'},
        X,
        Path
    ).
...
'v_msg_MatchStateResp.Action'(
    ...
    v_type_string(F2, [who | Path], TrUserData),
    v_type_int32(F3, [x | Path], TrUserData),
    v_type_int32(F4, [y | Path], TrUserData),
    ok;
'v_msg_MatchStateResp.Action'(X, Path, _TrUserData) ->
    mk_type_error(
        {expected_msg, 'MatchStateResp.Action'},
        X,
        Path
    ).
...
v_msg_MatchStateResp(
    ...
    if
        ...
        true ->
            mk_type_error(
                {invalid_list_of, {msg, 'MatchStateResp.Tile'}},
                F2,
                [board | Path]
            )
    end,
    ...
    if
        ...
        true ->
            mk_type_error(
                {invalid_list_of, {msg, 'MatchStateResp.Action'}},
                F5,
                [replay | Path]
            )
    end,
    if
        F6 == undefined -> ok;
        true -> v_type_int32(F6, [timer | Path], TrUserData)
    end,
    ok;
v_msg_MatchStateResp(X, Path, _TrUserData) ->
    mk_type_error(
        {expected_msg, 'MatchStateResp'},
        X,
        Path
    ).
...
-compile({nowarn_unused_function, 'v_msg_MatchDecideReq.Action'/3}).

-dialyzer({nowarn_function, 'v_msg_MatchDecideReq.Action'/3}).
...
'v_msg_MatchDecideReq.Action'(
    ...
    v_type_string(F1, [item | Path], TrUserData),
    if
        F2 == undefined -> ok;
        true -> v_type_int32(F2, [x | Path], TrUserData)
    end,
    if
        F3 == undefined -> ok;
        true -> v_type_int32(F3, [y | Path], TrUserData)
    end,
    if
        F4 == undefined -> ok;
        true -> v_type_string(F4, [target | Path], TrUserData)
    end,
    ok;
'v_msg_MatchDecideReq.Action'(X, Path, _TrUserData) ->
    mk_type_error(
        {expected_msg, 'MatchDecideReq.Action'},
        X,
        Path
    ).
...
v_msg_MatchDecideReq(
    ...
    if
        ...
        true ->
            mk_type_error(
                {invalid_list_of, {msg, 'MatchDecideReq.Action'}},
                F2,
                [actions | Path]
            )
    end,
...
v_msg_MatchDecideResp(
    #'MatchDecideResp'{resp = F1},
    Path,
    TrUserData
) ->
    v_msg_ResponseObject(F1, [resp | Path], TrUserData),
...
v_msg_MatchDecideResp(X, Path, _TrUserData) ->
    mk_type_error(
        {expected_msg, 'MatchDecideResp'},
        X,
        Path
    ).

-compile({nowarn_unused_function, 'v_msg_MatchIntentResp.Action'/3}).

-dialyzer({nowarn_function, 'v_msg_MatchIntentResp.Action'/3}).
...
'v_msg_MatchIntentResp.Action'(
    ...
    ok;
'v_msg_MatchIntentResp.Action'(X, Path, _TrUserData) ->
    mk_type_error(
        {expected_msg, 'MatchIntentResp.Action'},
        X,
        Path
    ).

-compile({nowarn_unused_function, v_msg_MatchIntentResp/3}).

-dialyzer({nowarn_function, v_msg_MatchIntentResp/3}).

v_msg_MatchIntentResp(
    #'MatchIntentResp'{
        player = F1,
        action = F2
    },
    ...
    ok;
v_msg_MatchIntentResp(X, Path, _TrUserData) ->
    mk_type_error(
        {expected_msg, 'MatchIntentResp'},
        X,
        Path
    ).

-compile({nowarn_unused_function, 'v_msg_ShipValidateReq.Component'/3}).

-dialyzer({nowarn_function, 'v_msg_ShipValidateReq.Component'/3}).
...
'v_msg_ShipValidateReq.Component'(
    ...
    v_type_int32(F4, [rotation | Path], TrUserData),
    ok;
'v_msg_ShipValidateReq.Component'(
    X,
    Path,
    ...
    mk_type_error(
        {expected_msg, 'ShipValidateReq.Component'},
        X,
        Path
    ).

-compile({nowarn_unused_function, v_msg_ShipValidateReq/3}).

-dialyzer({nowarn_function, v_msg_ShipValidateReq/3}).

v_msg_ShipValidateReq(
    #'ShipValidateReq'{
        components =
            F1
    },
    ...
    if
        ...
        true ->
            mk_type_error(
                {invalid_list_of, {msg, 'ShipValidateReq.Component'}},
                F1,
                [components | Path]
            )
    end,
    ok;
v_msg_ShipValidateReq(X, Path, _TrUserData) ->
    mk_type_error(
        {expected_msg, 'ShipValidateReq'},
        X,
        Path
    ).

-compile({nowarn_unused_function, v_msg_ShipValidateResp/3}).

-dialyzer({nowarn_function, v_msg_ShipValidateResp/3}).

v_msg_ShipValidateResp(
    #'ShipValidateResp'{resp = F1},
    Path,
    TrUserData
) ->
    v_msg_ResponseObject(F1, [resp | Path], TrUserData),
    ok;
v_msg_ShipValidateResp(X, Path, _TrUserData) ->
    mk_type_error(
        {expected_msg, 'ShipValidateResp'},
        X,
        Path
    ).
...
v_enum_MatchStateMachine(
    ...
    ok;
v_enum_MatchStateMachine(V, Path, TrUserData) when is_integer(V) ->
    v_type_sint32(V, Path, TrUserData);
v_enum_MatchStateMachine(X, Path, _TrUserData) ->
    mk_type_error(
        {invalid_enum, 'MatchStateMachine'},
        X,
        Path
    ).
...
v_enum_PlayerRole('INTERCEPTOR', _Path, _TrUserData) ->
    ok;
v_enum_PlayerRole('CARRIER', _Path, _TrUserData) ->
    ok;
v_enum_PlayerRole('COMMAND', _Path, _TrUserData) ->
    ok;
v_enum_PlayerRole(V, Path, TrUserData) when is_integer(V) ->
    v_type_sint32(V, Path, TrUserData);
...
-compile({nowarn_unused_function, 'v_enum_PlayerListResp.Status'/3}).

-dialyzer({nowarn_function, 'v_enum_PlayerListResp.Status'/3}).
...
'v_enum_PlayerListResp.Status'(
    ...
    ok;
'v_enum_PlayerListResp.Status'(V, Path, TrUserData) when is_integer(V) ->
    v_type_sint32(V, Path, TrUserData);
'v_enum_PlayerListResp.Status'(X, Path, _TrUserData) ->
    mk_type_error(
        {invalid_enum, 'PlayerListResp.Status'},
        X,
        Path
    ).
...
v_type_int32(N, _Path, _TrUserData) when
    -2147483648 =< N, N =< 2147483647
->
    ok;
v_type_int32(N, Path, _TrUserData) when is_integer(N) ->
    mk_type_error(
        {value_out_of_range, int32, signed, 32},
        N,
        Path
    );
v_type_int32(X, Path, _TrUserData) ->
    mk_type_error(
        {bad_integer, int32, signed, 32},
        X,
        Path
    ).
...
v_type_uint64(N, _Path, _TrUserData) when
...
get_msg_defs() ->
    [
        ...
        {{enum, 'PlayerListResp.Status'}, [{'OK', 0}, {'ERROR', 1}]},
        {{msg, 'ResponseObject'}, [
            #field{
                name = status,
                fnum = 1,
        ...
        {{msg, 'PlayerListResp'}, [
            #field{
                ...
                fnum = 1,
                rnum = 2,
                type = {enum, 'PlayerListResp.Status'},
                occurrence = required,
                opts = []
            },
            #field{
        ...
        {{msg, 'MatchDecideReq'}, [
            ...
            #field{
                ...
                fnum = 2,
                rnum = 3,
                type = {msg, 'MatchDecideReq.Action'},
                occurrence = repeated,
                opts = []
            },
            #field{
        ...
        {{msg, 'MatchIntentResp'}, [
            ...
            #field{
                ...
                fnum = 2,
                rnum = 3,
                type = {msg, 'MatchIntentResp.Action'},
                occurrence = required,
                opts = []
            }
        ]},
        {{msg, 'ShipValidateReq.Component'}, [
            #field{
                name = x,
                fnum = 1,
                rnum = 2,
        ...
        {{msg, 'ShipValidateReq'}, [
            #field{
                ...
                fnum = 1,
                rnum = 2,
                type = {msg, 'ShipValidateReq.Component'},
                occurrence = repeated,
                opts = []
            }
        ]},
        {{msg, 'ShipValidateResp'}, [
            #field{
                name = resp,
                fnum = 1,
                rnum = 2,
...
find_msg_def('MatchDecideReq.Action') ->
    [
        #field{
            name = item,
            fnum = 1,
...
find_msg_def('MatchIntentResp.Action') ->
    [
        #field{
            name = type,
            fnum = 1,
...
find_msg_def('ShipValidateReq.Component') ->
    [
        #field{
            name = x,
            fnum = 1,
...
find_enum_def('PlayerNewResp.Status') ->
    [{'OK', 0}, {'ERROR', 1}];
find_enum_def('PlayerListResp.Status') ->
    [{'OK', 0}, {'ERROR', 1}];
find_enum_def(_) ->
    error.
...
enum_symbol_by_value('PlayerListResp.Status', Value) ->
    'enum_symbol_by_value_PlayerListResp.Status'(Value).
...
enum_value_by_symbol('PlayerListResp.Status', Sym) ->
    'enum_value_by_symbol_PlayerListResp.Status'(Sym).
...
'enum_symbol_by_value_PlayerListResp.Status'(0) -> 'OK';
'enum_symbol_by_value_PlayerListResp.Status'(1) -> 'ERROR'.

'enum_value_by_symbol_PlayerListResp.Status'('OK') -> 0;
'enum_value_by_symbol_PlayerListResp.Status'('ERROR') -> 1.
...
fqbin_to_msg_name(<<"shipgame.ResponseObject">>) ->
    'ResponseObject';
fqbin_to_msg_name(<<"shipgame.MatchInfo">>) ->
    'MatchInfo';
fqbin_to_msg_name(<<"shipgame.AccountNewReq">>) ->
    'AccountNewReq';
fqbin_to_msg_name(<<"shipgame.AccountNewResp">>) ->
    'AccountNewResp';
fqbin_to_msg_name(<<"shipgame.AccountLoginReq">>) ->
    'AccountLoginReq';
fqbin_to_msg_name(<<"shipgame.AccountLoginResp">>) ->
    'AccountLoginResp';
fqbin_to_msg_name(<<"shipgame.PlayerNewReq">>) ->
    'PlayerNewReq';
fqbin_to_msg_name(<<"shipgame.PlayerNewResp">>) ->
    'PlayerNewResp';
fqbin_to_msg_name(<<"shipgame.PlayerListResp">>) ->
    'PlayerListResp';
fqbin_to_msg_name(<<"shipgame.PlayerInfoResp">>) ->
    'PlayerInfoResp';
fqbin_to_msg_name(<<"shipgame.PlayerAuthenticate">>) ->
    'PlayerAuthenticate';
fqbin_to_msg_name(<<"shipgame.ClientLog">>) ->
    'ClientLog';
fqbin_to_msg_name(<<"shipgame.MatchListResp">>) ->
    'MatchListResp';
fqbin_to_msg_name(<<"shipgame.MatchCreateReq">>) ->
    'MatchCreateReq';
fqbin_to_msg_name(<<"shipgame.MatchCreateResp">>) ->
    'MatchCreateResp';
fqbin_to_msg_name(<<"shipgame.MatchJoinReq">>) ->
    'MatchJoinReq';
fqbin_to_msg_name(<<"shipgame.MatchJoinResp">>) ->
    'MatchJoinResp';
fqbin_to_msg_name(<<"shipgame.MatchLeaveReq">>) ->
    'MatchLeaveReq';
fqbin_to_msg_name(<<"shipgame.MatchLeaveResp">>) ->
    'MatchLeaveResp';
fqbin_to_msg_name(<<"shipgame.MatchStartReq">>) ->
    'MatchStartReq';
fqbin_to_msg_name(<<"shipgame.MatchStartResp">>) ->
    'MatchStartResp';
fqbin_to_msg_name(<<"shipgame.MatchInfoReq">>) ->
    'MatchInfoReq';
fqbin_to_msg_name(<<"shipgame.MatchInfoResp">>) ->
    'MatchInfoResp';
fqbin_to_msg_name(<<"shipgame.MatchStateResp.Tile">>) ->
    'MatchStateResp.Tile';
fqbin_to_msg_name(<<"shipgame.MatchStateResp.Action">>) ->
    'MatchStateResp.Action';
fqbin_to_msg_name(<<"shipgame.MatchStateResp">>) ->
    'MatchStateResp';
fqbin_to_msg_name(<<"shipgame.MatchPrepReq">>) ->
    'MatchPrepReq';
fqbin_to_msg_name(<<"shipgame.MatchPrepResp">>) ->
    'MatchPrepResp';
fqbin_to_msg_name(<<"shipgame.MatchDecideReq.Action">>) ->
    'MatchDecideReq.Action';
fqbin_to_msg_name(<<"shipgame.MatchDecideReq">>) ->
    'MatchDecideReq';
fqbin_to_msg_name(<<"shipgame.MatchDecideResp">>) ->
    'MatchDecideResp';
fqbin_to_msg_name(<<"shipgame.MatchIntentResp.Action">>) ->
    'MatchIntentResp.Action';
fqbin_to_msg_name(<<"shipgame.MatchIntentResp">>) ->
    'MatchIntentResp';
fqbin_to_msg_name(<<"shipgame.ShipValidateReq.Component">>) ->
    'ShipValidateReq.Component';
fqbin_to_msg_name(<<"shipgame.ShipValidateReq">>) ->
    'ShipValidateReq';
fqbin_to_msg_name(<<"shipgame.ShipValidateResp">>) ->
    'ShipValidateResp';
fqbin_to_msg_name(E) ->
    error({gpb_error, {badmsg, E}}).

msg_name_to_fqbin('ResponseObject') ->
    <<"shipgame.ResponseObject">>;
msg_name_to_fqbin('MatchInfo') ->
    <<"shipgame.MatchInfo">>;
msg_name_to_fqbin('AccountNewReq') ->
    <<"shipgame.AccountNewReq">>;
msg_name_to_fqbin('AccountNewResp') ->
    <<"shipgame.AccountNewResp">>;
msg_name_to_fqbin('AccountLoginReq') ->
    <<"shipgame.AccountLoginReq">>;
msg_name_to_fqbin('AccountLoginResp') ->
    <<"shipgame.AccountLoginResp">>;
msg_name_to_fqbin('PlayerNewReq') ->
    <<"shipgame.PlayerNewReq">>;
msg_name_to_fqbin('PlayerNewResp') ->
    <<"shipgame.PlayerNewResp">>;
msg_name_to_fqbin('PlayerListResp') ->
    <<"shipgame.PlayerListResp">>;
msg_name_to_fqbin('PlayerInfoResp') ->
    <<"shipgame.PlayerInfoResp">>;
msg_name_to_fqbin('PlayerAuthenticate') ->
    <<"shipgame.PlayerAuthenticate">>;
msg_name_to_fqbin('ClientLog') ->
    <<"shipgame.ClientLog">>;
msg_name_to_fqbin('MatchListResp') ->
    <<"shipgame.MatchListResp">>;
msg_name_to_fqbin('MatchCreateReq') ->
    <<"shipgame.MatchCreateReq">>;
msg_name_to_fqbin('MatchCreateResp') ->
    <<"shipgame.MatchCreateResp">>;
msg_name_to_fqbin('MatchJoinReq') ->
    <<"shipgame.MatchJoinReq">>;
msg_name_to_fqbin('MatchJoinResp') ->
    <<"shipgame.MatchJoinResp">>;
msg_name_to_fqbin('MatchLeaveReq') ->
    <<"shipgame.MatchLeaveReq">>;
msg_name_to_fqbin('MatchLeaveResp') ->
    <<"shipgame.MatchLeaveResp">>;
msg_name_to_fqbin('MatchStartReq') ->
    <<"shipgame.MatchStartReq">>;
msg_name_to_fqbin('MatchStartResp') ->
    <<"shipgame.MatchStartResp">>;
msg_name_to_fqbin('MatchInfoReq') ->
    <<"shipgame.MatchInfoReq">>;
msg_name_to_fqbin('MatchInfoResp') ->
    <<"shipgame.MatchInfoResp">>;
msg_name_to_fqbin('MatchStateResp.Tile') ->
    <<"shipgame.MatchStateResp.Tile">>;
msg_name_to_fqbin('MatchStateResp.Action') ->
    <<"shipgame.MatchStateResp.Action">>;
msg_name_to_fqbin('MatchStateResp') ->
    <<"shipgame.MatchStateResp">>;
msg_name_to_fqbin('MatchPrepReq') ->
    <<"shipgame.MatchPrepReq">>;
msg_name_to_fqbin('MatchPrepResp') ->
    <<"shipgame.MatchPrepResp">>;
msg_name_to_fqbin('MatchDecideReq.Action') ->
    <<"shipgame.MatchDecideReq.Action">>;
msg_name_to_fqbin('MatchDecideReq') ->
    <<"shipgame.MatchDecideReq">>;
msg_name_to_fqbin('MatchDecideResp') ->
    <<"shipgame.MatchDecideResp">>;
msg_name_to_fqbin('MatchIntentResp.Action') ->
    <<"shipgame.MatchIntentResp.Action">>;
msg_name_to_fqbin('MatchIntentResp') ->
    <<"shipgame.MatchIntentResp">>;
msg_name_to_fqbin('ShipValidateReq.Component') ->
    <<"shipgame.ShipValidateReq.Component">>;
msg_name_to_fqbin('ShipValidateReq') ->
    <<"shipgame.ShipValidateReq">>;
msg_name_to_fqbin('ShipValidateResp') ->
    <<"shipgame.ShipValidateResp">>;
msg_name_to_fqbin(E) ->
    error({gpb_error, {badmsg, E}}).

fqbin_to_enum_name(<<"shipgame.MatchState">>) ->
    'MatchState';
fqbin_to_enum_name(<<"shipgame.MatchMode">>) ->
    'MatchMode';
fqbin_to_enum_name(<<"shipgame.MatchStateMachine">>) ->
    'MatchStateMachine';
fqbin_to_enum_name(<<"shipgame.PlayerRole">>) ->
    'PlayerRole';
fqbin_to_enum_name(<<"shipgame.ItemAction">>) ->
    'ItemAction';
fqbin_to_enum_name(<<"shipgame.ResponseObject.Status">>) ->
    'ResponseObject.Status';
fqbin_to_enum_name(<<"shipgame.AccountNewResp.Status">>) ->
    'AccountNewResp.Status';
fqbin_to_enum_name(<<"shipgame.AccountLoginResp.Status">>) ->
    'AccountLoginResp.Status';
fqbin_to_enum_name(<<"shipgame.PlayerNewResp.Status">>) ->
    'PlayerNewResp.Status';
fqbin_to_enum_name(<<"shipgame.PlayerListResp.Status">>) ->
    'PlayerListResp.Status';
fqbin_to_enum_name(E) ->
    error({gpb_error, {badenum, E}}).

enum_name_to_fqbin('MatchState') ->
    <<"shipgame.MatchState">>;
enum_name_to_fqbin('MatchMode') ->
    <<"shipgame.MatchMode">>;
enum_name_to_fqbin('MatchStateMachine') ->
    <<"shipgame.MatchStateMachine">>;
enum_name_to_fqbin('PlayerRole') ->
    <<"shipgame.PlayerRole">>;
enum_name_to_fqbin('ItemAction') ->
    <<"shipgame.ItemAction">>;
enum_name_to_fqbin('ResponseObject.Status') ->
    <<"shipgame.ResponseObject.Status">>;
enum_name_to_fqbin('AccountNewResp.Status') ->
    <<"shipgame.AccountNewResp.Status">>;
enum_name_to_fqbin('AccountLoginResp.Status') ->
    <<"shipgame.AccountLoginResp.Status">>;
enum_name_to_fqbin('PlayerNewResp.Status') ->
    <<"shipgame.PlayerNewResp.Status">>;
enum_name_to_fqbin('PlayerListResp.Status') ->
    <<"shipgame.PlayerListResp.Status">>;
enum_name_to_fqbin(E) ->
    error({gpb_error, {badenum, E}}).

get_package_name() -> shipgame.

%% Whether or not the message names
%% are prepended with package name or not.
uses_packages() -> false.

source_basename() -> "shipgame.proto".
...
get_all_source_basenames() -> ["shipgame.proto"].
...
%% functions.
get_all_proto_names() -> ["shipgame"].

get_msg_containment("shipgame") ->
    [
        'AccountLoginReq',
        'AccountLoginResp',
        'AccountNewReq',
...
get_pkg_containment("shipgame") -> undefined;
get_pkg_containment(P) -> error({gpb_error, {badproto, P}}).

get_service_containment("shipgame") -> [];
get_service_containment(P) -> error({gpb_error, {badproto, P}}).

get_rpc_containment("shipgame") -> [];
get_rpc_containment(P) -> error({gpb_error, {badproto, P}}).

get_enum_containment("shipgame") ->
    [
        'AccountLoginResp.Status',
        'AccountNewResp.Status',
        'ItemAction',
...
get_proto_by_msg_name_as_fqbin(<<"shipgame.ShipValidateResp">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.PlayerNewResp">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.PlayerListResp">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.PlayerInfoResp">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchStateResp">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchStartResp">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchPrepResp">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchListResp">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchLeaveResp">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchJoinResp">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchIntentResp">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchInfoResp">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchDecideResp">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchCreateResp">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.AccountNewResp">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.AccountLoginResp">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.ShipValidateReq">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.PlayerNewReq">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchStartReq">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchPrepReq">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchLeaveReq">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchJoinReq">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchInfoReq">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchDecideReq">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchCreateReq">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.AccountNewReq">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.AccountLoginReq">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.ShipValidateReq.Component">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.ResponseObject">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.PlayerAuthenticate">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchStateResp.Tile">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.ClientLog">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchStateResp.Action">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchIntentResp.Action">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchDecideReq.Action">>) ->
    "shipgame";
get_proto_by_msg_name_as_fqbin(<<"shipgame.MatchInfo">>) ->
    "shipgame";
...
get_proto_by_enum_name_as_fqbin(<<"shipgame.ResponseObject.Status">>) ->
    "shipgame";
get_proto_by_enum_name_as_fqbin(<<"shipgame.PlayerNewResp.Status">>) ->
    "shipgame";
get_proto_by_enum_name_as_fqbin(<<"shipgame.PlayerListResp.Status">>) ->
    "shipgame";
get_proto_by_enum_name_as_fqbin(<<"shipgame.AccountNewResp.Status">>) ->
    "shipgame";
get_proto_by_enum_name_as_fqbin(<<"shipgame.AccountLoginResp.Status">>) ->
    "shipgame";
get_proto_by_enum_name_as_fqbin(<<"shipgame.PlayerRole">>) ->
    "shipgame";
get_proto_by_enum_name_as_fqbin(<<"shipgame.MatchStateMachine">>) ->
    "shipgame";
get_proto_by_enum_name_as_fqbin(<<"shipgame.MatchState">>) ->
    "shipgame";
get_proto_by_enum_name_as_fqbin(<<"shipgame.MatchMode">>) ->
    "shipgame";
get_proto_by_enum_name_as_fqbin(<<"shipgame.ItemAction">>) ->
    "shipgame";
