...
-export(['enum_symbol_by_value_PlayerListResp.Status'/1, 'enum_value_by_symbol_PlayerListResp.Status'/1]).
...
-export_type(['MatchState'/0, 'MatchMode'/0, 'MatchStateMachine'/0, 'PlayerRole'/0, 'ItemAction'/0, 'ResponseObject.Status'/0, 'AccountNewResp.Status'/0, 'AccountLoginResp.Status'/0, 'PlayerNewResp.Status'/0, 'PlayerListResp.Status'/0]).
...
-export_type(['ResponseObject'/0, 'MatchInfo'/0, 'AccountNewReq'/0, 'AccountNewResp'/0, 'AccountLoginReq'/0, 'AccountLoginResp'/0, 'PlayerNewReq'/0, 'PlayerNewResp'/0, 'PlayerListResp'/0, 'PlayerInfoResp'/0, 'PlayerAuthenticate'/0, 'PlayerLog'/0, 'MatchListResp'/0, 'MatchCreateReq'/0, 'MatchCreateResp'/0, 'MatchJoinReq'/0, 'MatchJoinResp'/0, 'MatchLeaveReq'/0, 'MatchLeaveResp'/0, 'MatchStartReq'/0, 'MatchStartResp'/0, 'MatchInfoReq'/0, 'MatchInfoResp'/0, 'MatchStateResp.Tile'/0, 'MatchStateResp.Action'/0, 'MatchStateResp'/0, 'MatchPrepReq'/0, 'MatchPrepResp'/0, 'MatchDecideReq.Action'/0, 'MatchDecideReq'/0, 'MatchDecideResp'/0, 'MatchIntentResp.Action'/0, 'MatchIntentResp'/0]).

-spec encode_msg(#'ResponseObject'{} | #'MatchInfo'{} | #'AccountNewReq'{} | #'AccountNewResp'{} | #'AccountLoginReq'{} | #'AccountLoginResp'{} | #'PlayerNewReq'{} | #'PlayerNewResp'{} | #'PlayerListResp'{} | #'PlayerInfoResp'{} | #'PlayerAuthenticate'{} | #'PlayerLog'{} | #'MatchListResp'{} | #'MatchCreateReq'{} | #'MatchCreateResp'{} | #'MatchJoinReq'{} | #'MatchJoinResp'{} | #'MatchLeaveReq'{} | #'MatchLeaveResp'{} | #'MatchStartReq'{} | #'MatchStartResp'{} | #'MatchInfoReq'{} | #'MatchInfoResp'{} | #'MatchStateResp.Tile'{} | #'MatchStateResp.Action'{} | #'MatchStateResp'{} | #'MatchPrepReq'{} | #'MatchPrepResp'{} | #'MatchDecideReq.Action'{} | #'MatchDecideReq'{} | #'MatchDecideResp'{} | #'MatchIntentResp.Action'{} | #'MatchIntentResp'{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#'ResponseObject'{} | #'MatchInfo'{} | #'AccountNewReq'{} | #'AccountNewResp'{} | #'AccountLoginReq'{} | #'AccountLoginResp'{} | #'PlayerNewReq'{} | #'PlayerNewResp'{} | #'PlayerListResp'{} | #'PlayerInfoResp'{} | #'PlayerAuthenticate'{} | #'PlayerLog'{} | #'MatchListResp'{} | #'MatchCreateReq'{} | #'MatchCreateResp'{} | #'MatchJoinReq'{} | #'MatchJoinResp'{} | #'MatchLeaveReq'{} | #'MatchLeaveResp'{} | #'MatchStartReq'{} | #'MatchStartResp'{} | #'MatchInfoReq'{} | #'MatchInfoResp'{} | #'MatchStateResp.Tile'{} | #'MatchStateResp.Action'{} | #'MatchStateResp'{} | #'MatchPrepReq'{} | #'MatchPrepResp'{} | #'MatchDecideReq.Action'{} | #'MatchDecideReq'{} | #'MatchDecideResp'{} | #'MatchIntentResp.Action'{} | #'MatchIntentResp'{}, atom() | list()) -> binary().
    ...
    case MsgName of
        ...
        'PlayerNewResp' ->
            encode_msg_PlayerNewResp(id(Msg, TrUserData),
                                     TrUserData);
        'PlayerListResp' ->
            encode_msg_PlayerListResp(id(Msg, TrUserData),
                                      TrUserData);
        'PlayerInfoResp' ->
            encode_msg_PlayerInfoResp(id(Msg, TrUserData),
                                      TrUserData);
        'PlayerAuthenticate' ->
        ...
        'MatchListResp' ->
            encode_msg_MatchListResp(id(Msg, TrUserData),
                                     TrUserData);
        'MatchCreateReq' ->
        ...
        'MatchDecideReq.Action' ->
            'encode_msg_MatchDecideReq.Action'(id(Msg, TrUserData),
                                               TrUserData);
        'MatchDecideReq' ->
        ...
        'MatchIntentResp.Action' ->
            'encode_msg_MatchIntentResp.Action'(id(Msg, TrUserData),
                                                TrUserData);
        'MatchIntentResp' ->
            encode_msg_MatchIntentResp(id(Msg, TrUserData),
                                       TrUserData)
    end.
...
encode_msg_PlayerNewReq(#'PlayerNewReq'{name = F1,
    ...
    B3 = begin
             ...
             if TrF3 == [] -> B2;
                true ->
                    e_field_PlayerNewReq_symbol(TrF3, B2, TrUserData)
             end
         end,
    begin
        TrF4 = id(F4, TrUserData),
...
encode_msg_PlayerListResp(#'PlayerListResp'{status = F1,
                                            players = F2, error = F3},
                          Bin, TrUserData) ->
    B1 = begin
             TrF1 = id(F1, TrUserData),
             'e_enum_PlayerListResp.Status'(TrF1,
                                            <<Bin/binary, 8>>,
                                            TrUserData)
         end,
    B2 = begin
             ...
             if TrF2 == [] -> B1;
                true ->
                    e_field_PlayerListResp_players(TrF2, B1, TrUserData)
             end
         end,
    if F3 == undefined -> B2;
       true ->
...
encode_msg_PlayerInfoResp(#'PlayerInfoResp'{name = F1,
                                            health = F2, energy = F3,
                                            flags = F4, inventory = F5},
                          Bin, TrUserData) ->
    B1 = begin
             TrF1 = id(F1, TrUserData),
             e_type_string(TrF1, <<Bin/binary, 10>>, TrUserData)
    ...
    B4 = begin
             ...
             if TrF4 == [] -> B3;
                true ->
                    e_field_PlayerInfoResp_flags(TrF4, B3, TrUserData)
             end
         end,
    begin
        TrF5 = id(F5, TrUserData),
        if TrF5 == [] -> B4;
           true ->
               e_field_PlayerInfoResp_inventory(TrF5, B4, TrUserData)
        end
    end.
...
encode_msg_MatchListResp(#'MatchListResp'{resp = F1,
                                          matches = F2},
                         Bin, TrUserData) ->
    B1 = begin
             TrF1 = id(F1, TrUserData),
             e_mfield_MatchListResp_resp(TrF1,
                                         <<Bin/binary, 10>>,
                                         TrUserData)
         end,
    begin
        ...
        if TrF2 == [] -> B1;
           true ->
               e_field_MatchListResp_matches(TrF2, B1, TrUserData)
        end
    end.
...
encode_msg_MatchCreateReq(#'MatchCreateReq'{player = F1,
                                            mode = F2, players_max = F3,
                                            extra = F4},
                          Bin, TrUserData) ->
    B1 = begin
             TrF1 = id(F1, TrUserData),
...
'encode_msg_MatchStateResp.Action'(#'MatchStateResp.Action'{type
                                                                = F1,
                                                            who = F2, x = F3,
                                                            y = F4},
                                   Bin, TrUserData) ->
...
encode_msg_MatchStateResp(#'MatchStateResp'{state = F1,
                                            board = F2, playerlist = F3,
                                            readyplayers = F4, replay = F5,
                                            timer = F6},
                          Bin, TrUserData) ->
    B1 = begin
             TrF1 = id(F1, TrUserData),
    ...
    B2 = begin
             ...
             if TrF2 == [] -> B1;
                true ->
                    e_field_MatchStateResp_board(TrF2, B1, TrUserData)
             end
         end,
    B3 = begin
             TrF3 = id(F3, TrUserData),
    ...
    B5 = begin
             ...
             if TrF5 == [] -> B4;
                true ->
                    e_field_MatchStateResp_replay(TrF5, B4, TrUserData)
             end
         end,
    if F6 == undefined -> B5;
       true ->
...
'encode_msg_MatchDecideReq.Action'(Msg, TrUserData) ->
    'encode_msg_MatchDecideReq.Action'(Msg,
                                       <<>>,
                                       TrUserData).


'encode_msg_MatchDecideReq.Action'(#'MatchDecideReq.Action'{item
                                                                = F1,
                                                            x = F2, y = F3,
                                                            target = F4},
                                   Bin, TrUserData) ->
...
encode_msg_MatchDecideReq(#'MatchDecideReq'{player = F1,
    ...
    B2 = begin
             ...
             if TrF2 == [] -> B1;
                true ->
                    e_field_MatchDecideReq_actions(TrF2, B1, TrUserData)
             end
         end,
    begin
        TrF3 = id(F3, TrUserData),
...
'encode_msg_MatchIntentResp.Action'(Msg, TrUserData) ->
    'encode_msg_MatchIntentResp.Action'(Msg,
                                        <<>>,
                                        TrUserData).


'encode_msg_MatchIntentResp.Action'(#'MatchIntentResp.Action'{type
                                                                  = F1,
                                                              x = F2, y = F3,
                                                              target = F4},
                                    Bin, TrUserData) ->
...
encode_msg_MatchIntentResp(#'MatchIntentResp'{player =
                                                  F1,
                                              action = F2},
                           Bin, TrUserData) ->
    B1 = begin
    ...
    begin
        TrF2 = id(F2, TrUserData),
        e_mfield_MatchIntentResp_action(TrF2,
                                        <<B1/binary, 18>>,
                                        TrUserData)
    end.
...
e_field_PlayerNewReq_color([Elem | Rest], Bin,
                           TrUserData) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 = e_type_string(id(Elem, TrUserData),
                         Bin2,
...
e_field_PlayerNewReq_color([], Bin, _TrUserData) -> Bin.

e_field_PlayerNewReq_symbol([Elem | Rest], Bin,
                            TrUserData) ->
    Bin2 = <<Bin/binary, 24>>,
...
e_field_PlayerListResp_players([Elem | Rest], Bin,
                               TrUserData) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 = e_type_string(id(Elem, TrUserData),
                         Bin2,
...
e_field_PlayerInfoResp_flags([Elem | Rest], Bin,
                             TrUserData) ->
    Bin2 = <<Bin/binary, 34>>,
    Bin3 = e_type_string(id(Elem, TrUserData),
                         Bin2,
...
e_field_PlayerInfoResp_inventory([Elem | Rest], Bin,
                                 TrUserData) ->
    Bin2 = <<Bin/binary, 42>>,
    Bin3 = e_type_string(id(Elem, TrUserData),
                         Bin2,
                         TrUserData),
    e_field_PlayerInfoResp_inventory(Rest,
                                     Bin3,
                                     TrUserData);
e_field_PlayerInfoResp_inventory([], Bin,
                                 _TrUserData) ->
    Bin.
...
e_field_MatchListResp_matches([Elem | Rest], Bin,
                              TrUserData) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 = e_mfield_MatchListResp_matches(id(Elem,
                                             TrUserData),
                                          Bin2,
                                          TrUserData),
...
e_field_MatchStateResp_board([Elem | Rest], Bin,
                             TrUserData) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 = e_mfield_MatchStateResp_board(id(Elem,
                                            TrUserData),
                                         Bin2,
                                         TrUserData),
...
e_field_MatchStateResp_replay([Elem | Rest], Bin,
                              TrUserData) ->
    Bin2 = <<Bin/binary, 42>>,
    Bin3 = e_mfield_MatchStateResp_replay(id(Elem,
                                             TrUserData),
                                          Bin2,
                                          TrUserData),
...
e_mfield_MatchDecideReq_actions(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_MatchDecideReq.Action'(Msg,
                                                <<>>,
                                                TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

e_field_MatchDecideReq_actions([Elem | Rest], Bin,
                               TrUserData) ->
    Bin2 = <<Bin/binary, 18>>,
    Bin3 = e_mfield_MatchDecideReq_actions(id(Elem,
                                              TrUserData),
                                           Bin2,
                                           TrUserData),
...
e_mfield_MatchIntentResp_action(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_MatchIntentResp.Action'(Msg,
                                                 <<>>,
                                                 TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.
...
'e_enum_PlayerListResp.Status'('OK', Bin,
                               _TrUserData) ->
    <<Bin/binary, 0>>;
'e_enum_PlayerListResp.Status'('ERROR', Bin,
                               _TrUserData) ->
    <<Bin/binary, 1>>;
...
decode_msg_2_doit('PlayerListResp', Bin, TrUserData) ->
    id(decode_msg_PlayerListResp(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('PlayerInfoResp', Bin, TrUserData) ->
    id(decode_msg_PlayerInfoResp(Bin, TrUserData),
       TrUserData);
...
decode_msg_2_doit('MatchListResp', Bin, TrUserData) ->
    id(decode_msg_MatchListResp(Bin, TrUserData),
       TrUserData);
...
decode_msg_2_doit('MatchPrepResp', Bin, TrUserData) ->
    id(decode_msg_MatchPrepResp(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('MatchDecideReq.Action', Bin,
                  TrUserData) ->
    id('decode_msg_MatchDecideReq.Action'(Bin, TrUserData),
       TrUserData);
...
decode_msg_2_doit('MatchDecideResp', Bin, TrUserData) ->
    id(decode_msg_MatchDecideResp(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('MatchIntentResp.Action', Bin,
                  TrUserData) ->
    id('decode_msg_MatchIntentResp.Action'(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('MatchIntentResp', Bin, TrUserData) ->
    id(decode_msg_MatchIntentResp(Bin, TrUserData),
       TrUserData).
...
dfp_read_field_def_PlayerNewReq(<<18, Rest/binary>>, Z1,
                                Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    d_field_PlayerNewReq_color(Rest,
                               Z1,
                               Z2,
                               F@_1,
                               F@_2,
                               ...
                               F@_4,
                               TrUserData);
dfp_read_field_def_PlayerNewReq(<<26, Rest/binary>>, Z1,
                                Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    d_pfield_PlayerNewReq_symbol(Rest,
                                 Z1,
                                 Z2,
                                 F@_1,
                                 F@_2,
...
dfp_read_field_def_PlayerNewReq(<<24, Rest/binary>>, Z1,
                                Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    d_field_PlayerNewReq_symbol(Rest,
                                Z1,
                                Z2,
                                F@_1,
                                F@_2,
                                ...
                                F@_4,
                                TrUserData);
dfp_read_field_def_PlayerNewReq(<<32, Rest/binary>>, Z1,
                                Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    d_field_PlayerNewReq_role(Rest,
                              ...
                              F@_4,
                              TrUserData);
dfp_read_field_def_PlayerNewReq(<<>>, 0, 0, F@_1, R1,
                                R2, F@_4, TrUserData) ->
    #'PlayerNewReq'{name = F@_1,
                    color = lists_reverse(R1, TrUserData),
                    symbol = lists_reverse(R2, TrUserData), role = F@_4};
...
dg_read_field_def_PlayerNewReq(<<>>, 0, 0, F@_1, R1, R2,
                               F@_4, TrUserData) ->
    #'PlayerNewReq'{name = F@_1,
                    color = lists_reverse(R1, TrUserData),
                    symbol = lists_reverse(R2, TrUserData), role = F@_4}.
...
d_field_PlayerNewReq_color(<<1:1, X:7, Rest/binary>>, N,
                           Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_PlayerNewReq_color(Rest,
                               N + 7,
                               ...
                               F@_4,
                               TrUserData);
d_field_PlayerNewReq_color(<<0:1, X:7, Rest/binary>>, N,
...
d_field_PlayerNewReq_symbol(<<1:1, X:7, Rest/binary>>,
                            N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_PlayerNewReq_symbol(Rest,
                                N + 7,
                                ...
                                F@_4,
                                TrUserData);
d_field_PlayerNewReq_symbol(<<0:1, X:7, Rest/binary>>,
...
d_pfield_PlayerNewReq_symbol(<<1:1, X:7, Rest/binary>>,
                             N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_pfield_PlayerNewReq_symbol(Rest,
                                 N + 7,
                                 ...
                                 F@_4,
                                 TrUserData);
d_pfield_PlayerNewReq_symbol(<<0:1, X:7, Rest/binary>>,
                             N, Acc, F@_1, F@_2, E, F@_4, TrUserData) ->
    Len = X bsl N + Acc,
    <<PackedBytes:Len/binary, Rest2/binary>> = Rest,
    NewSeq = d_packed_field_PlayerNewReq_symbol(PackedBytes,
                                                0,
                                                0,
                                                E,
                                                TrUserData),
...
d_packed_field_PlayerNewReq_symbol(<<1:1, X:7,
                                     Rest/binary>>,
                                   N, Acc, AccSeq, TrUserData)
    when N < 57 ->
    d_packed_field_PlayerNewReq_symbol(Rest,
                                       N + 7,
                                       X bsl N + Acc,
                                       AccSeq,
                                       TrUserData);
d_packed_field_PlayerNewReq_symbol(<<0:1, X:7,
                                     Rest/binary>>,
                                   N, Acc, AccSeq, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
                          Rest},
    d_packed_field_PlayerNewReq_symbol(RestF,
                                       0,
                                       0,
                                       [NewFValue | AccSeq],
                                       TrUserData);
d_packed_field_PlayerNewReq_symbol(<<>>, 0, 0, AccSeq,
                                   _) ->
    AccSeq.
...
decode_msg_PlayerListResp(Bin, TrUserData) ->
    dfp_read_field_def_PlayerListResp(Bin,
                                      0,
                                      0,
                                      id(undefined, TrUserData),
                                      id([], TrUserData),
...
dfp_read_field_def_PlayerListResp(<<8, Rest/binary>>,
                                  Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_PlayerListResp_status(Rest,
                                  Z1,
                                  Z2,
                                  F@_1,
                                  F@_2,
                                  F@_3,
                                  TrUserData);
dfp_read_field_def_PlayerListResp(<<18, Rest/binary>>,
                                  Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_PlayerListResp_players(Rest,
                                   Z1,
                                   Z2,
                                   F@_1,
                                   F@_2,
                                   F@_3,
                                   TrUserData);
dfp_read_field_def_PlayerListResp(<<26, Rest/binary>>,
                                  Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    d_field_PlayerListResp_error(Rest,
                                 Z1,
                                 Z2,
                                 F@_1,
                                 F@_2,
                                 F@_3,
                                 TrUserData);
dfp_read_field_def_PlayerListResp(<<>>, 0, 0, F@_1, R1,
                                  F@_3, TrUserData) ->
    #'PlayerListResp'{status = F@_1,
                      players = lists_reverse(R1, TrUserData), error = F@_3};
dfp_read_field_def_PlayerListResp(Other, Z1, Z2, F@_1,
                                  F@_2, F@_3, TrUserData) ->
    dg_read_field_def_PlayerListResp(Other,
                                     Z1,
                                     Z2,
                                     F@_1,
                                     F@_2,
...
dg_read_field_def_PlayerListResp(<<1:1, X:7,
                                   Rest/binary>>,
                                 N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_PlayerListResp(Rest,
                                     N + 7,
                                     X bsl N + Acc,
                                     F@_1,
                                     F@_2,
                                     F@_3,
                                     TrUserData);
dg_read_field_def_PlayerListResp(<<0:1, X:7,
                                   Rest/binary>>,
                                 N, Acc, F@_1, F@_2, F@_3, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    skip_varint_PlayerListResp(Rest,
                                               0,
                                               0,
                                               F@_1,
                                               F@_2,
                ...
                1 ->
                    skip_64_PlayerListResp(Rest,
                                           ...
                                           TrUserData);
                2 ->
                    skip_length_delimited_PlayerListResp(Rest,
                                                         0,
                                                         0,
                                                         F@_1,
                                                         F@_2,
                                                         ...
                                                         TrUserData);
                3 ->
                    skip_group_PlayerListResp(Rest,
                                              Key bsr 3,
                                              0,
                                              F@_1,
                                              F@_2,
...
dg_read_field_def_PlayerListResp(<<>>, 0, 0, F@_1, R1,
                                 F@_3, TrUserData) ->
    #'PlayerListResp'{status = F@_1,
                      players = lists_reverse(R1, TrUserData), error = F@_3}.

d_field_PlayerListResp_status(<<1:1, X:7, Rest/binary>>,
                              N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_PlayerListResp_status(Rest,
                                  N + 7,
                                  ...
                                  F@_3,
                                  TrUserData);
d_field_PlayerListResp_status(<<0:1, X:7, Rest/binary>>,
                              N, Acc, _, F@_2, F@_3, TrUserData) ->
    {NewFValue, RestF} =
        {id('d_enum_PlayerListResp.Status'(begin
                                               <<Res:32/signed-native>> = <<(X
                                                                                 bsl
                                                                                 N
                                                                                 +
            ...
            TrUserData),
         Rest},
    dfp_read_field_def_PlayerListResp(RestF,
                                      0,
                                      0,
                                      NewFValue,
                                      F@_2,
...
d_field_PlayerListResp_players(<<1:1, X:7,
                                 Rest/binary>>,
                               N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_PlayerListResp_players(Rest,
                                   ...
                                   F@_3,
                                   TrUserData);
d_field_PlayerListResp_players(<<0:1, X:7,
                                 Rest/binary>>,
                               N, Acc, F@_1, Prev, F@_3, TrUserData) ->
    {NewFValue, RestF} = begin
                             Len = X bsl N + Acc,
...
d_field_PlayerListResp_error(<<1:1, X:7, Rest/binary>>,
                             N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    d_field_PlayerListResp_error(Rest,
                                 N + 7,
                                 ...
                                 F@_3,
                                 TrUserData);
d_field_PlayerListResp_error(<<0:1, X:7, Rest/binary>>,
                             N, Acc, F@_1, F@_2, _, TrUserData) ->
    {NewFValue, RestF} = begin
                             Len = X bsl N + Acc,
                             <<Utf8:Len/binary, Rest2/binary>> = Rest,
...
skip_varint_PlayerListResp(<<1:1, _:7, Rest/binary>>,
                           Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    skip_varint_PlayerListResp(Rest,
                               Z1,
                               Z2,
                               ...
                               F@_3,
                               TrUserData);
skip_varint_PlayerListResp(<<0:1, _:7, Rest/binary>>,
                           Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_PlayerListResp(Rest,
                                      Z1,
                                      Z2,
                                      F@_1,
                                      F@_2,
...
skip_length_delimited_PlayerListResp(<<1:1, X:7,
                                       Rest/binary>>,
                                     N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    skip_length_delimited_PlayerListResp(Rest,
                                         ...
                                         F@_3,
                                         TrUserData);
skip_length_delimited_PlayerListResp(<<0:1, X:7,
                                       Rest/binary>>,
                                     N, Acc, F@_1, F@_2, F@_3, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_PlayerListResp(Rest2,
                                      0,
                                      0,
                                      F@_1,
                                      F@_2,
...
skip_group_PlayerListResp(Bin, FNum, Z2, F@_1, F@_2,
                          F@_3, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_PlayerListResp(Rest,
                                      0,
...
skip_32_PlayerListResp(<<_:32, Rest/binary>>, Z1, Z2,
                       F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_PlayerListResp(Rest,
                                      Z1,
                                      Z2,
...
skip_64_PlayerListResp(<<_:64, Rest/binary>>, Z1, Z2,
                       F@_1, F@_2, F@_3, TrUserData) ->
    dfp_read_field_def_PlayerListResp(Rest,
                                      Z1,
                                      Z2,
...
decode_msg_PlayerInfoResp(Bin, TrUserData) ->
    dfp_read_field_def_PlayerInfoResp(Bin,
                                      0,
                                      0,
                                      id(undefined, TrUserData),
                                      id(undefined, TrUserData),
...
dfp_read_field_def_PlayerInfoResp(<<10, Rest/binary>>,
                                  Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                  TrUserData) ->
    d_field_PlayerInfoResp_name(Rest,
                                Z1,
                                Z2,
                                F@_1,
                                F@_2,
                                ...
                                F@_5,
                                TrUserData);
dfp_read_field_def_PlayerInfoResp(<<16, Rest/binary>>,
                                  Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                  TrUserData) ->
    d_field_PlayerInfoResp_health(Rest,
                                  Z1,
                                  Z2,
                                  F@_1,
                                  F@_2,
                                  ...
                                  F@_5,
                                  TrUserData);
dfp_read_field_def_PlayerInfoResp(<<24, Rest/binary>>,
                                  Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                  TrUserData) ->
    d_field_PlayerInfoResp_energy(Rest,
                                  Z1,
                                  Z2,
                                  F@_1,
                                  F@_2,
                                  ...
                                  F@_5,
                                  TrUserData);
dfp_read_field_def_PlayerInfoResp(<<34, Rest/binary>>,
                                  Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                  TrUserData) ->
    d_field_PlayerInfoResp_flags(Rest,
                                 Z1,
                                 Z2,
                                 F@_1,
                                 F@_2,
                                 ...
                                 F@_5,
                                 TrUserData);
dfp_read_field_def_PlayerInfoResp(<<42, Rest/binary>>,
                                  Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
                                  TrUserData) ->
    d_field_PlayerInfoResp_inventory(Rest,
                                     Z1,
                                     Z2,
                                     F@_1,
                                     F@_2,
                                     ...
                                     F@_5,
                                     TrUserData);
dfp_read_field_def_PlayerInfoResp(<<>>, 0, 0, F@_1,
                                  F@_2, F@_3, R1, R2, TrUserData) ->
    #'PlayerInfoResp'{name = F@_1, health = F@_2,
                      energy = F@_3, flags = lists_reverse(R1, TrUserData),
                      inventory = lists_reverse(R2, TrUserData)};
dfp_read_field_def_PlayerInfoResp(Other, Z1, Z2, F@_1,
                                  F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dg_read_field_def_PlayerInfoResp(Other,
                                     Z1,
                                     Z2,
                                     F@_1,
                                     F@_2,
...
dg_read_field_def_PlayerInfoResp(<<1:1, X:7,
                                   Rest/binary>>,
                                 N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
                                 TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_PlayerInfoResp(Rest,
                                     N + 7,
                                     X bsl N + Acc,
                                     F@_1,
                                     F@_2,
                                     ...
                                     F@_5,
                                     TrUserData);
dg_read_field_def_PlayerInfoResp(<<0:1, X:7,
                                   Rest/binary>>,
                                 N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
                                 TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    skip_varint_PlayerInfoResp(Rest,
                                               0,
                                               0,
                                               F@_1,
                                               F@_2,
                ...
                1 ->
                    skip_64_PlayerInfoResp(Rest,
                                           ...
                                           TrUserData);
                2 ->
                    skip_length_delimited_PlayerInfoResp(Rest,
                                                         0,
                                                         0,
                                                         F@_1,
                                                         F@_2,
                                                         ...
                                                         TrUserData);
                3 ->
                    skip_group_PlayerInfoResp(Rest,
                                              Key bsr 3,
                                              0,
                                              F@_1,
                                              F@_2,
...
dg_read_field_def_PlayerInfoResp(<<>>, 0, 0, F@_1, F@_2,
                                 F@_3, R1, R2, TrUserData) ->
    #'PlayerInfoResp'{name = F@_1, health = F@_2,
                      energy = F@_3, flags = lists_reverse(R1, TrUserData),
                      inventory = lists_reverse(R2, TrUserData)}.

d_field_PlayerInfoResp_name(<<1:1, X:7, Rest/binary>>,
    ...
    d_field_PlayerInfoResp_name(Rest,
                                ...
                                F@_5,
                                TrUserData);
d_field_PlayerInfoResp_name(<<0:1, X:7, Rest/binary>>,
    ...
    dfp_read_field_def_PlayerInfoResp(RestF,
                                      0,
                                      0,
                                      NewFValue,
                                      F@_2,
...
d_field_PlayerInfoResp_health(<<1:1, X:7, Rest/binary>>,
                              N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData)
    when N < 57 ->
    d_field_PlayerInfoResp_health(Rest,
                                  N + 7,
                                  ...
                                  F@_5,
                                  TrUserData);
d_field_PlayerInfoResp_health(<<0:1, X:7, Rest/binary>>,
...
d_field_PlayerInfoResp_energy(<<1:1, X:7, Rest/binary>>,
                              N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData)
    when N < 57 ->
    d_field_PlayerInfoResp_energy(Rest,
                                  N + 7,
                                  ...
                                  F@_5,
                                  TrUserData);
d_field_PlayerInfoResp_energy(<<0:1, X:7, Rest/binary>>,
...
d_field_PlayerInfoResp_flags(<<1:1, X:7, Rest/binary>>,
                             N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData)
    when N < 57 ->
    d_field_PlayerInfoResp_flags(Rest,
                                 N + 7,
                                 ...
                                 F@_5,
                                 TrUserData);
d_field_PlayerInfoResp_flags(<<0:1, X:7, Rest/binary>>,
...
d_field_PlayerInfoResp_inventory(<<1:1, X:7,
                                   Rest/binary>>,
                                 N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
                                 TrUserData)
    when N < 57 ->
    d_field_PlayerInfoResp_inventory(Rest,
                                     ...
                                     F@_5,
                                     TrUserData);
d_field_PlayerInfoResp_inventory(<<0:1, X:7,
                                   Rest/binary>>,
...
skip_varint_PlayerInfoResp(<<1:1, _:7, Rest/binary>>,
    ...
    skip_varint_PlayerInfoResp(Rest,
                               ...
                               F@_5,
                               TrUserData);
skip_varint_PlayerInfoResp(<<0:1, _:7, Rest/binary>>,
                           Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_PlayerInfoResp(Rest,
                                      Z1,
                                      Z2,
                                      F@_1,
                                      F@_2,
...
skip_length_delimited_PlayerInfoResp(<<1:1, X:7,
                                       Rest/binary>>,
                                     N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
                                     TrUserData)
    when N < 57 ->
    skip_length_delimited_PlayerInfoResp(Rest,
                                         ...
                                         F@_5,
                                         TrUserData);
skip_length_delimited_PlayerInfoResp(<<0:1, X:7,
                                       Rest/binary>>,
                                     N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
                                     TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_PlayerInfoResp(Rest2,
                                      0,
                                      0,
                                      F@_1,
                                      F@_2,
...
skip_group_PlayerInfoResp(Bin, FNum, Z2, F@_1, F@_2,
...
skip_32_PlayerInfoResp(<<_:32, Rest/binary>>, Z1, Z2,
...
skip_64_PlayerInfoResp(<<_:64, Rest/binary>>, Z1, Z2,
                       F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_PlayerInfoResp(Rest,
                                      Z1,
                                      Z2,
...
decode_msg_MatchListResp(Bin, TrUserData) ->
    dfp_read_field_def_MatchListResp(Bin,
                                     0,
                                     0,
                                     id(undefined, TrUserData),
                                     id([], TrUserData),
...
dfp_read_field_def_MatchListResp(<<10, Rest/binary>>,
                                 Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_MatchListResp_resp(Rest,
                               Z1,
                               Z2,
                               F@_1,
                               F@_2,
                               TrUserData);
dfp_read_field_def_MatchListResp(<<18, Rest/binary>>,
                                 Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_MatchListResp_matches(Rest,
                                  Z1,
                                  Z2,
                                  F@_1,
                                  F@_2,
                                  TrUserData);
dfp_read_field_def_MatchListResp(<<>>, 0, 0, F@_1, R1,
                                 TrUserData) ->
    #'MatchListResp'{resp = F@_1,
                     matches = lists_reverse(R1, TrUserData)};
dfp_read_field_def_MatchListResp(Other, Z1, Z2, F@_1,
                                 F@_2, TrUserData) ->
    dg_read_field_def_MatchListResp(Other,
                                    Z1,
                                    Z2,
                                    F@_1,
                                    F@_2,
...
dg_read_field_def_MatchListResp(<<1:1, X:7,
                                  Rest/binary>>,
                                N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_MatchListResp(Rest,
                                    N + 7,
                                    X bsl N + Acc,
                                    F@_1,
                                    F@_2,
                                    TrUserData);
dg_read_field_def_MatchListResp(<<0:1, X:7,
                                  Rest/binary>>,
                                N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    skip_varint_MatchListResp(Rest,
                                              0,
                                              0,
                                              F@_1,
                                              F@_2,
                ...
                1 ->
                    skip_64_MatchListResp(Rest,
                                          ...
                                          TrUserData);
                2 ->
                    skip_length_delimited_MatchListResp(Rest,
                                                        0,
                                                        0,
                                                        F@_1,
                                                        F@_2,
...
dg_read_field_def_MatchListResp(<<>>, 0, 0, F@_1, R1,
                                TrUserData) ->
    #'MatchListResp'{resp = F@_1,
                     matches = lists_reverse(R1, TrUserData)}.

d_field_MatchListResp_resp(<<1:1, X:7, Rest/binary>>, N,
    ...
    d_field_MatchListResp_resp(Rest,
                               ...
                               F@_2,
                               TrUserData);
d_field_MatchListResp_resp(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_MatchListResp(RestF,
                                     0,
                                     0,
...
d_field_MatchListResp_matches(<<1:1, X:7, Rest/binary>>,
                              N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_MatchListResp_matches(Rest,
                                  N + 7,
                                  ...
                                  F@_2,
                                  TrUserData);
d_field_MatchListResp_matches(<<0:1, X:7, Rest/binary>>,
...
skip_varint_MatchListResp(<<1:1, _:7, Rest/binary>>, Z1,
                          Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_MatchListResp(Rest,
                              Z1,
                              Z2,
                              ...
                              F@_2,
                              TrUserData);
skip_varint_MatchListResp(<<0:1, _:7, Rest/binary>>, Z1,
                          Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_MatchListResp(Rest,
                                     Z1,
                                     Z2,
                                     F@_1,
                                     F@_2,
...
skip_length_delimited_MatchListResp(<<1:1, X:7,
                                      Rest/binary>>,
                                    N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_MatchListResp(Rest,
                                        ...
                                        F@_2,
                                        TrUserData);
skip_length_delimited_MatchListResp(<<0:1, X:7,
                                      Rest/binary>>,
                                    N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_MatchListResp(Rest2,
                                     0,
                                     0,
                                     F@_1,
                                     F@_2,
...
skip_group_MatchListResp(Bin, FNum, Z2, F@_1, F@_2,
                         TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_MatchListResp(Rest,
                                     0,
...
skip_32_MatchListResp(<<_:32, Rest/binary>>, Z1, Z2,
                      F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_MatchListResp(Rest,
                                     Z1,
                                     Z2,
...
skip_64_MatchListResp(<<_:64, Rest/binary>>, Z1, Z2,
                      F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_MatchListResp(Rest,
                                     Z1,
                                     Z2,
...
dfp_read_field_def_MatchCreateReq(<<10, Rest/binary>>,
                                  Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    d_field_MatchCreateReq_player(Rest,
                                  Z1,
                                  Z2,
                                  F@_1,
                                  F@_2,
...
dfp_read_field_def_MatchCreateReq(<<16, Rest/binary>>,
    ...
    d_field_MatchCreateReq_mode(Rest,
                                ...
                                F@_4,
                                TrUserData);
dfp_read_field_def_MatchCreateReq(<<24, Rest/binary>>,
                                  Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    d_field_MatchCreateReq_players_max(Rest,
                                       ...
                                       F@_4,
                                       TrUserData);
dfp_read_field_def_MatchCreateReq(<<34, Rest/binary>>,
                                  Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
...
dfp_read_field_def_MatchCreateReq(<<>>, 0, 0, F@_1,
                                  F@_2, F@_3, F@_4, _) ->
    #'MatchCreateReq'{player = F@_1, mode = F@_2,
                      players_max = F@_3, extra = F@_4};
...
d_field_MatchCreateReq_player(<<1:1, X:7, Rest/binary>>,
                              N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    d_field_MatchCreateReq_player(Rest,
                                  N + 7,
                                  ...
                                  F@_4,
                                  TrUserData);
d_field_MatchCreateReq_player(<<0:1, X:7, Rest/binary>>,
...
'dfp_read_field_def_MatchStateResp.Action'(<<10,
                                             Rest/binary>>,
...
'dfp_read_field_def_MatchStateResp.Action'(<<18,
                                           ...
                                           Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                           TrUserData) ->
    'd_field_MatchStateResp.Action_who'(Rest,
                                        Z1,
                                        Z2,
                                        F@_1,
                                        F@_2,
...
'dfp_read_field_def_MatchStateResp.Action'(<<24,
                                           ...
                                           Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                           TrUserData) ->
    'd_field_MatchStateResp.Action_x'(Rest,
                                      Z1,
                                      Z2,
                                      F@_1,
                                      F@_2,
...
'dfp_read_field_def_MatchStateResp.Action'(<<32,
                                           ...
                                           Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                           TrUserData) ->
    'd_field_MatchStateResp.Action_y'(Rest,
                                      Z1,
                                      Z2,
                                      F@_1,
                                      F@_2,
...
'dfp_read_field_def_MatchStateResp.Action'(<<>>, 0, 0,
    ...
    #'MatchStateResp.Action'{type = F@_1, who = F@_2,
                             x = F@_3, y = F@_4};
...
'd_field_MatchStateResp.Action_who'(<<1:1, X:7,
                                      Rest/binary>>,
                                    N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    'd_field_MatchStateResp.Action_who'(Rest,
                                        ...
                                        F@_4,
                                        TrUserData);
'd_field_MatchStateResp.Action_who'(<<0:1, X:7,
                                      Rest/binary>>,
                                    N, Acc, F@_1, _, F@_3, F@_4, TrUserData) ->
    {NewFValue, RestF} = begin
                             Len = X bsl N + Acc,
...
'd_field_MatchStateResp.Action_x'(<<1:1, X:7,
                                    Rest/binary>>,
                                  N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    'd_field_MatchStateResp.Action_x'(Rest,
                                      ...
                                      F@_4,
                                      TrUserData);
'd_field_MatchStateResp.Action_x'(<<0:1, X:7,
                                    Rest/binary>>,
                                  N, Acc, F@_1, F@_2, _, F@_4, TrUserData) ->
    {NewFValue, RestF} = {begin
                              <<Res:32/signed-native>> = <<(X bsl N +
...
'd_field_MatchStateResp.Action_y'(<<1:1, X:7,
                                    Rest/binary>>,
                                  N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    'd_field_MatchStateResp.Action_y'(Rest,
                                      ...
                                      F@_4,
                                      TrUserData);
'd_field_MatchStateResp.Action_y'(<<0:1, X:7,
                                    Rest/binary>>,
                                  N, Acc, F@_1, F@_2, F@_3, _, TrUserData) ->
    {NewFValue, RestF} = {begin
                              <<Res:32/signed-native>> = <<(X bsl N +
...
dfp_read_field_def_MatchStateResp(<<18, Rest/binary>>,
                                  Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                  TrUserData) ->
    d_field_MatchStateResp_board(Rest,
                                 Z1,
                                 Z2,
                                 F@_1,
                                 F@_2,
...
dfp_read_field_def_MatchStateResp(<<42, Rest/binary>>,
                                  Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                  TrUserData) ->
    d_field_MatchStateResp_replay(Rest,
                                  Z1,
                                  Z2,
                                  F@_1,
                                  F@_2,
                                  ...
                                  F@_6,
                                  TrUserData);
dfp_read_field_def_MatchStateResp(<<48, Rest/binary>>,
                                  Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                                  TrUserData) ->
    d_field_MatchStateResp_timer(Rest,
                                 Z1,
                                 Z2,
                                 F@_1,
                                 F@_2,
...
dfp_read_field_def_MatchStateResp(<<>>, 0, 0, F@_1, R1,
    ...
    #'MatchStateResp'{state = F@_1,
                      ...
                      replay = lists_reverse(R4, TrUserData), timer = F@_6};
...
d_field_MatchStateResp_board(<<1:1, X:7, Rest/binary>>,
                             N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                             TrUserData)
    when N < 57 ->
    d_field_MatchStateResp_board(Rest,
                                 ...
                                 F@_6,
                                 TrUserData);
d_field_MatchStateResp_board(<<0:1, X:7, Rest/binary>>,
...
d_field_MatchStateResp_replay(<<1:1, X:7, Rest/binary>>,
                              N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                              TrUserData)
    when N < 57 ->
    d_field_MatchStateResp_replay(Rest,
                                  ...
                                  F@_6,
                                  TrUserData);
d_field_MatchStateResp_replay(<<0:1, X:7, Rest/binary>>,
...
d_field_MatchStateResp_timer(<<1:1, X:7, Rest/binary>>,
                             N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
                             TrUserData)
    when N < 57 ->
    d_field_MatchStateResp_timer(Rest,
                                 ...
                                 F@_6,
                                 TrUserData);
d_field_MatchStateResp_timer(<<0:1, X:7, Rest/binary>>,
...
'decode_msg_MatchDecideReq.Action'(Bin, TrUserData) ->
    'dfp_read_field_def_MatchDecideReq.Action'(Bin,
                                               0,
                                               0,
                                               id(undefined, TrUserData),
                                               id(undefined, TrUserData),
...
'dfp_read_field_def_MatchDecideReq.Action'(<<10,
                                             Rest/binary>>,
                                           Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                           TrUserData) ->
    'd_field_MatchDecideReq.Action_item'(Rest,
                                         Z1,
                                         Z2,
                                         F@_1,
                                         F@_2,
                                         ...
                                         F@_4,
                                         TrUserData);
'dfp_read_field_def_MatchDecideReq.Action'(<<16,
                                             Rest/binary>>,
                                           Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                           TrUserData) ->
    'd_field_MatchDecideReq.Action_x'(Rest,
                                      Z1,
                                      Z2,
                                      F@_1,
                                      F@_2,
                                      ...
                                      F@_4,
                                      TrUserData);
'dfp_read_field_def_MatchDecideReq.Action'(<<24,
                                             Rest/binary>>,
                                           Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                           TrUserData) ->
    'd_field_MatchDecideReq.Action_y'(Rest,
                                      Z1,
                                      Z2,
                                      F@_1,
                                      F@_2,
                                      ...
                                      F@_4,
                                      TrUserData);
'dfp_read_field_def_MatchDecideReq.Action'(<<34,
                                             Rest/binary>>,
                                           Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                           TrUserData) ->
    'd_field_MatchDecideReq.Action_target'(Rest,
                                           Z1,
                                           Z2,
                                           F@_1,
                                           F@_2,
                                           ...
                                           F@_4,
                                           TrUserData);
'dfp_read_field_def_MatchDecideReq.Action'(<<>>, 0, 0,
                                           F@_1, F@_2, F@_3, F@_4, _) ->
    #'MatchDecideReq.Action'{item = F@_1, x = F@_2,
                             y = F@_3, target = F@_4};
'dfp_read_field_def_MatchDecideReq.Action'(Other, Z1,
                                           Z2, F@_1, F@_2, F@_3, F@_4,
                                           TrUserData) ->
    'dg_read_field_def_MatchDecideReq.Action'(Other,
                                              Z1,
                                              Z2,
                                              F@_1,
                                              F@_2,
...
'dg_read_field_def_MatchDecideReq.Action'(<<1:1, X:7,
                                            Rest/binary>>,
                                          N, Acc, F@_1, F@_2, F@_3, F@_4,
                                          TrUserData)
    when N < 32 - 7 ->
    'dg_read_field_def_MatchDecideReq.Action'(Rest,
                                              N + 7,
                                              X bsl N + Acc,
                                              F@_1,
                                              F@_2,
                                              ...
                                              F@_4,
                                              TrUserData);
'dg_read_field_def_MatchDecideReq.Action'(<<0:1, X:7,
                                            Rest/binary>>,
                                          N, Acc, F@_1, F@_2, F@_3, F@_4,
                                          TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    'skip_varint_MatchDecideReq.Action'(Rest,
                                                        0,
                                                        0,
                                                        F@_1,
                                                        F@_2,
                                                        ...
                                                        TrUserData);
                1 ->
                    'skip_64_MatchDecideReq.Action'(Rest,
                                                    0,
                                                    0,
                                                    F@_1,
                                                    F@_2,
                                                    ...
                                                    TrUserData);
                2 ->
                    'skip_length_delimited_MatchDecideReq.Action'(Rest,
                                                                  0,
                                                                  0,
                                                                  F@_1,
                                                                  F@_2,
                                                                  ...
                                                                  TrUserData);
                3 ->
                    'skip_group_MatchDecideReq.Action'(Rest,
                                                       Key bsr 3,
                                                       0,
                                                       F@_1,
                                                       F@_2,
                                                       ...
                                                       TrUserData);
                5 ->
                    'skip_32_MatchDecideReq.Action'(Rest,
                                                    0,
                                                    0,
                                                    F@_1,
                                                    F@_2,
...
'dg_read_field_def_MatchDecideReq.Action'(<<>>, 0, 0,
                                          F@_1, F@_2, F@_3, F@_4, _) ->
    #'MatchDecideReq.Action'{item = F@_1, x = F@_2,
                             y = F@_3, target = F@_4}.

'd_field_MatchDecideReq.Action_item'(<<1:1, X:7,
                                       Rest/binary>>,
                                     N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    'd_field_MatchDecideReq.Action_item'(Rest,
                                         ...
                                         F@_4,
                                         TrUserData);
'd_field_MatchDecideReq.Action_item'(<<0:1, X:7,
                                       Rest/binary>>,
                                     N, Acc, _, F@_2, F@_3, F@_4, TrUserData) ->
    {NewFValue, RestF} = begin
                             Len = X bsl N + Acc,
    ...
    'dfp_read_field_def_MatchDecideReq.Action'(RestF,
                                               0,
                                               0,
                                               NewFValue,
                                               F@_2,
...
'd_field_MatchDecideReq.Action_x'(<<1:1, X:7,
                                    Rest/binary>>,
                                  N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    'd_field_MatchDecideReq.Action_x'(Rest,
                                      ...
                                      F@_4,
                                      TrUserData);
'd_field_MatchDecideReq.Action_x'(<<0:1, X:7,
                                    Rest/binary>>,
                                  N, Acc, F@_1, _, F@_3, F@_4, TrUserData) ->
    {NewFValue, RestF} = {begin
                              <<Res:32/signed-native>> = <<(X bsl N +
...
'd_field_MatchDecideReq.Action_y'(<<1:1, X:7,
                                    Rest/binary>>,
                                  N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    'd_field_MatchDecideReq.Action_y'(Rest,
                                      ...
                                      F@_4,
                                      TrUserData);
'd_field_MatchDecideReq.Action_y'(<<0:1, X:7,
                                    Rest/binary>>,
                                  N, Acc, F@_1, F@_2, _, F@_4, TrUserData) ->
    {NewFValue, RestF} = {begin
                              <<Res:32/signed-native>> = <<(X bsl N +
...
'd_field_MatchDecideReq.Action_target'(<<1:1, X:7,
                                         Rest/binary>>,
                                       N, Acc, F@_1, F@_2, F@_3, F@_4,
                                       TrUserData)
    when N < 57 ->
    'd_field_MatchDecideReq.Action_target'(Rest,
                                           ...
                                           F@_4,
                                           TrUserData);
'd_field_MatchDecideReq.Action_target'(<<0:1, X:7,
                                         Rest/binary>>,
...
'skip_varint_MatchDecideReq.Action'(<<1:1, _:7,
                                      Rest/binary>>,
                                    Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                    TrUserData) ->
    'skip_varint_MatchDecideReq.Action'(Rest,
                                        ...
                                        F@_4,
                                        TrUserData);
'skip_varint_MatchDecideReq.Action'(<<0:1, _:7,
                                      Rest/binary>>,
                                    Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                    TrUserData) ->
    'dfp_read_field_def_MatchDecideReq.Action'(Rest,
                                               Z1,
                                               Z2,
                                               F@_1,
                                               F@_2,
...
'skip_length_delimited_MatchDecideReq.Action'(<<1:1,
                                                X:7, Rest/binary>>,
                                              N, Acc, F@_1, F@_2, F@_3, F@_4,
                                              TrUserData)
    when N < 57 ->
    'skip_length_delimited_MatchDecideReq.Action'(Rest,
                                                  ...
                                                  F@_4,
                                                  TrUserData);
'skip_length_delimited_MatchDecideReq.Action'(<<0:1,
                                                X:7, Rest/binary>>,
                                              N, Acc, F@_1, F@_2, F@_3, F@_4,
                                              TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_MatchDecideReq.Action'(Rest2,
                                               0,
                                               0,
                                               F@_1,
                                               F@_2,
...
'skip_group_MatchDecideReq.Action'(Bin, FNum, Z2, F@_1,
                                   F@_2, F@_3, F@_4, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_MatchDecideReq.Action'(Rest,
                                               0,
...
'skip_32_MatchDecideReq.Action'(<<_:32, Rest/binary>>,
                                Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    'dfp_read_field_def_MatchDecideReq.Action'(Rest,
                                               Z1,
                                               Z2,
...
'skip_64_MatchDecideReq.Action'(<<_:64, Rest/binary>>,
                                Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    'dfp_read_field_def_MatchDecideReq.Action'(Rest,
                                               Z1,
                                               Z2,
...
dfp_read_field_def_MatchDecideReq(<<24, Rest/binary>>,
    ...
    d_field_MatchDecideReq_matchid(Rest,
                                   ...
                                   F@_3,
                                   TrUserData);
dfp_read_field_def_MatchDecideReq(<<>>, 0, 0, F@_1, R1,
                                  F@_3, TrUserData) ->
    #'MatchDecideReq'{player = F@_1,
...
dg_read_field_def_MatchDecideReq(<<>>, 0, 0, F@_1, R1,
                                 F@_3, TrUserData) ->
    #'MatchDecideReq'{player = F@_1,
                      actions = lists_reverse(R1, TrUserData),
                      matchid = F@_3}.
...
d_field_MatchDecideReq_actions(<<0:1, X:7,
    ...
    {NewFValue, RestF} = begin
                             Len = X bsl N + Acc,
                             <<Bs:Len/binary, Rest2/binary>> = Rest,
                             {id('decode_msg_MatchDecideReq.Action'(Bs,
                                                                    TrUserData),
                                 TrUserData),
                              Rest2}
                         end,
...
'decode_msg_MatchIntentResp.Action'(Bin, TrUserData) ->
    'dfp_read_field_def_MatchIntentResp.Action'(Bin,
                                                0,
                                                0,
                                                id(undefined, TrUserData),
                                                id(undefined, TrUserData),
...
'dfp_read_field_def_MatchIntentResp.Action'(<<10,
                                              Rest/binary>>,
                                            Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                            TrUserData) ->
    'd_field_MatchIntentResp.Action_type'(Rest,
                                          Z1,
                                          Z2,
                                          F@_1,
                                          F@_2,
                                          ...
                                          F@_4,
                                          TrUserData);
'dfp_read_field_def_MatchIntentResp.Action'(<<16,
                                              Rest/binary>>,
                                            Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                            TrUserData) ->
    'd_field_MatchIntentResp.Action_x'(Rest,
                                       Z1,
                                       Z2,
                                       F@_1,
                                       F@_2,
                                       ...
                                       F@_4,
                                       TrUserData);
'dfp_read_field_def_MatchIntentResp.Action'(<<24,
                                              Rest/binary>>,
                                            Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                            TrUserData) ->
    'd_field_MatchIntentResp.Action_y'(Rest,
                                       Z1,
                                       Z2,
                                       F@_1,
                                       F@_2,
                                       ...
                                       F@_4,
                                       TrUserData);
'dfp_read_field_def_MatchIntentResp.Action'(<<34,
                                              Rest/binary>>,
                                            Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                            TrUserData) ->
    'd_field_MatchIntentResp.Action_target'(Rest,
                                            Z1,
                                            Z2,
                                            F@_1,
                                            F@_2,
                                            ...
                                            F@_4,
                                            TrUserData);
'dfp_read_field_def_MatchIntentResp.Action'(<<>>, 0, 0,
                                            F@_1, F@_2, F@_3, F@_4, _) ->
    #'MatchIntentResp.Action'{type = F@_1, x = F@_2,
                              y = F@_3, target = F@_4};
'dfp_read_field_def_MatchIntentResp.Action'(Other, Z1,
                                            Z2, F@_1, F@_2, F@_3, F@_4,
                                            TrUserData) ->
    'dg_read_field_def_MatchIntentResp.Action'(Other,
                                               Z1,
                                               Z2,
                                               F@_1,
                                               F@_2,
...
'dg_read_field_def_MatchIntentResp.Action'(<<1:1, X:7,
                                             Rest/binary>>,
                                           N, Acc, F@_1, F@_2, F@_3, F@_4,
                                           TrUserData)
    when N < 32 - 7 ->
    'dg_read_field_def_MatchIntentResp.Action'(Rest,
                                               N + 7,
                                               X bsl N + Acc,
                                               F@_1,
                                               F@_2,
                                               ...
                                               F@_4,
                                               TrUserData);
'dg_read_field_def_MatchIntentResp.Action'(<<0:1, X:7,
                                             Rest/binary>>,
                                           N, Acc, F@_1, F@_2, F@_3, F@_4,
                                           TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    'skip_varint_MatchIntentResp.Action'(Rest,
                                                         0,
                                                         0,
                                                         F@_1,
                                                         F@_2,
                                                         ...
                                                         TrUserData);
                1 ->
                    'skip_64_MatchIntentResp.Action'(Rest,
                                                     0,
                                                     0,
                                                     F@_1,
                                                     F@_2,
                                                     ...
                                                     TrUserData);
                2 ->
                    'skip_length_delimited_MatchIntentResp.Action'(Rest,
                                                                   0,
                                                                   0,
                                                                   F@_1,
                                                                   F@_2,
                                                                   ...
                                                                   TrUserData);
                3 ->
                    'skip_group_MatchIntentResp.Action'(Rest,
                                                        Key bsr 3,
                                                        0,
                                                        F@_1,
                                                        F@_2,
                                                        ...
                                                        TrUserData);
                5 ->
                    'skip_32_MatchIntentResp.Action'(Rest,
                                                     0,
                                                     0,
                                                     F@_1,
                                                     F@_2,
...
'dg_read_field_def_MatchIntentResp.Action'(<<>>, 0, 0,
                                           F@_1, F@_2, F@_3, F@_4, _) ->
    #'MatchIntentResp.Action'{type = F@_1, x = F@_2,
                              y = F@_3, target = F@_4}.

'd_field_MatchIntentResp.Action_type'(<<1:1, X:7,
                                        Rest/binary>>,
                                      N, Acc, F@_1, F@_2, F@_3, F@_4,
                                      TrUserData)
    when N < 57 ->
    'd_field_MatchIntentResp.Action_type'(Rest,
                                          ...
                                          F@_4,
                                          TrUserData);
'd_field_MatchIntentResp.Action_type'(<<0:1, X:7,
                                        Rest/binary>>,
    ...
    'dfp_read_field_def_MatchIntentResp.Action'(RestF,
                                                0,
                                                0,
                                                NewFValue,
                                                F@_2,
...
'd_field_MatchIntentResp.Action_x'(<<1:1, X:7,
                                     Rest/binary>>,
                                   N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    'd_field_MatchIntentResp.Action_x'(Rest,
                                       ...
                                       F@_4,
                                       TrUserData);
'd_field_MatchIntentResp.Action_x'(<<0:1, X:7,
                                     Rest/binary>>,
                                   N, Acc, F@_1, _, F@_3, F@_4, TrUserData) ->
    {NewFValue, RestF} = {begin
                              <<Res:32/signed-native>> = <<(X bsl N +
...
'd_field_MatchIntentResp.Action_y'(<<1:1, X:7,
                                     Rest/binary>>,
                                   N, Acc, F@_1, F@_2, F@_3, F@_4, TrUserData)
    when N < 57 ->
    'd_field_MatchIntentResp.Action_y'(Rest,
                                       ...
                                       F@_4,
                                       TrUserData);
'd_field_MatchIntentResp.Action_y'(<<0:1, X:7,
                                     Rest/binary>>,
                                   N, Acc, F@_1, F@_2, _, F@_4, TrUserData) ->
    {NewFValue, RestF} = {begin
                              <<Res:32/signed-native>> = <<(X bsl N +
...
'd_field_MatchIntentResp.Action_target'(<<1:1, X:7,
                                          Rest/binary>>,
                                        N, Acc, F@_1, F@_2, F@_3, F@_4,
                                        TrUserData)
    when N < 57 ->
    'd_field_MatchIntentResp.Action_target'(Rest,
                                            ...
                                            F@_4,
                                            TrUserData);
'd_field_MatchIntentResp.Action_target'(<<0:1, X:7,
                                          Rest/binary>>,
                                        N, Acc, F@_1, F@_2, F@_3, _,
                                        TrUserData) ->
    {NewFValue, RestF} = begin
...
'skip_varint_MatchIntentResp.Action'(<<1:1, _:7,
                                       Rest/binary>>,
                                     Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                     TrUserData) ->
    'skip_varint_MatchIntentResp.Action'(Rest,
                                         ...
                                         F@_4,
                                         TrUserData);
'skip_varint_MatchIntentResp.Action'(<<0:1, _:7,
                                       Rest/binary>>,
                                     Z1, Z2, F@_1, F@_2, F@_3, F@_4,
                                     TrUserData) ->
    'dfp_read_field_def_MatchIntentResp.Action'(Rest,
                                                Z1,
                                                Z2,
                                                F@_1,
                                                F@_2,
...
'skip_length_delimited_MatchIntentResp.Action'(<<1:1,
                                                 X:7, Rest/binary>>,
                                               N, Acc, F@_1, F@_2, F@_3, F@_4,
                                               TrUserData)
    when N < 57 ->
    'skip_length_delimited_MatchIntentResp.Action'(Rest,
                                                   ...
                                                   F@_4,
                                                   TrUserData);
'skip_length_delimited_MatchIntentResp.Action'(<<0:1,
                                                 X:7, Rest/binary>>,
                                               N, Acc, F@_1, F@_2, F@_3, F@_4,
                                               TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_MatchIntentResp.Action'(Rest2,
                                                0,
                                                0,
                                                F@_1,
                                                F@_2,
...
'skip_group_MatchIntentResp.Action'(Bin, FNum, Z2, F@_1,
                                    F@_2, F@_3, F@_4, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_MatchIntentResp.Action'(Rest,
                                                0,
...
'skip_32_MatchIntentResp.Action'(<<_:32, Rest/binary>>,
                                 Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    'dfp_read_field_def_MatchIntentResp.Action'(Rest,
                                                Z1,
                                                Z2,
...
'skip_64_MatchIntentResp.Action'(<<_:64, Rest/binary>>,
                                 Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    'dfp_read_field_def_MatchIntentResp.Action'(Rest,
                                                Z1,
                                                Z2,
...
decode_msg_MatchIntentResp(Bin, TrUserData) ->
    dfp_read_field_def_MatchIntentResp(Bin,
                                       0,
                                       0,
                                       id(undefined, TrUserData),
                                       id(undefined, TrUserData),
...
dfp_read_field_def_MatchIntentResp(<<10, Rest/binary>>,
                                   Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_MatchIntentResp_player(Rest,
                                   Z1,
                                   Z2,
                                   F@_1,
                                   F@_2,
                                   TrUserData);
dfp_read_field_def_MatchIntentResp(<<18, Rest/binary>>,
                                   Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_MatchIntentResp_action(Rest,
                                   Z1,
                                   Z2,
                                   F@_1,
                                   F@_2,
                                   TrUserData);
dfp_read_field_def_MatchIntentResp(<<>>, 0, 0, F@_1,
                                   F@_2, _) ->
    #'MatchIntentResp'{player = F@_1, action = F@_2};
dfp_read_field_def_MatchIntentResp(Other, Z1, Z2, F@_1,
                                   F@_2, TrUserData) ->
    dg_read_field_def_MatchIntentResp(Other,
                                      Z1,
                                      Z2,
                                      F@_1,
                                      F@_2,
...
dg_read_field_def_MatchIntentResp(<<1:1, X:7,
                                    Rest/binary>>,
                                  N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_MatchIntentResp(Rest,
                                      N + 7,
                                      X bsl N + Acc,
                                      F@_1,
                                      F@_2,
                                      TrUserData);
dg_read_field_def_MatchIntentResp(<<0:1, X:7,
                                    Rest/binary>>,
                                  N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    skip_varint_MatchIntentResp(Rest,
                                                0,
                                                0,
                                                F@_1,
                                                F@_2,
                ...
                1 ->
                    skip_64_MatchIntentResp(Rest,
                                            ...
                                            TrUserData);
                2 ->
                    skip_length_delimited_MatchIntentResp(Rest,
                                                          0,
                                                          0,
                                                          F@_1,
                                                          F@_2,
                                                          TrUserData);
                3 ->
                    skip_group_MatchIntentResp(Rest,
                                               Key bsr 3,
                                               0,
                                               F@_1,
                                               F@_2,
...
dg_read_field_def_MatchIntentResp(<<>>, 0, 0, F@_1,
                                  F@_2, _) ->
    #'MatchIntentResp'{player = F@_1, action = F@_2}.

d_field_MatchIntentResp_player(<<1:1, X:7,
                                 Rest/binary>>,
                               N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_MatchIntentResp_player(Rest,
                                   ...
                                   F@_2,
                                   TrUserData);
d_field_MatchIntentResp_player(<<0:1, X:7,
                                 Rest/binary>>,
                               N, Acc, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = begin
                             Len = X bsl N + Acc,
    ...
    dfp_read_field_def_MatchIntentResp(RestF,
                                       0,
                                       0,
                                       NewFValue,
                                       F@_2,
...
d_field_MatchIntentResp_action(<<1:1, X:7,
                                 Rest/binary>>,
                               N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_MatchIntentResp_action(Rest,
                                   ...
                                   F@_2,
                                   TrUserData);
d_field_MatchIntentResp_action(<<0:1, X:7,
                                 Rest/binary>>,
                               N, Acc, F@_1, Prev, TrUserData) ->
    {NewFValue, RestF} = begin
                             Len = X bsl N + Acc,
                             <<Bs:Len/binary, Rest2/binary>> = Rest,
                             {id('decode_msg_MatchIntentResp.Action'(Bs,
                                                                     TrUserData),
                                 TrUserData),
                              Rest2}
                         end,
    dfp_read_field_def_MatchIntentResp(RestF,
                                       ...
                                       if Prev == undefined -> NewFValue;
                                          true ->
                                              'merge_msg_MatchIntentResp.Action'(Prev,
                                                                                 NewFValue,
                                                                                 TrUserData)
                                       end,
                                       TrUserData).

skip_varint_MatchIntentResp(<<1:1, _:7, Rest/binary>>,
                            Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_MatchIntentResp(Rest,
                                Z1,
                                Z2,
                                ...
                                F@_2,
                                TrUserData);
skip_varint_MatchIntentResp(<<0:1, _:7, Rest/binary>>,
                            Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_MatchIntentResp(Rest,
                                       Z1,
                                       Z2,
                                       F@_1,
                                       F@_2,
...
skip_length_delimited_MatchIntentResp(<<1:1, X:7,
                                        Rest/binary>>,
                                      N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_MatchIntentResp(Rest,
                                          ...
                                          F@_2,
                                          TrUserData);
skip_length_delimited_MatchIntentResp(<<0:1, X:7,
                                        Rest/binary>>,
                                      N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_MatchIntentResp(Rest2,
                                       0,
                                       0,
                                       F@_1,
                                       F@_2,
...
skip_group_MatchIntentResp(Bin, FNum, Z2, F@_1, F@_2,
                           TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_MatchIntentResp(Rest,
                                       0,
...
skip_32_MatchIntentResp(<<_:32, Rest/binary>>, Z1, Z2,
                        F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_MatchIntentResp(Rest,
                                       Z1,
                                       Z2,
...
skip_64_MatchIntentResp(<<_:64, Rest/binary>>, Z1, Z2,
                        F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_MatchIntentResp(Rest,
                                       Z1,
                                       Z2,
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
        ...
        'MatchDecideReq.Action' ->
            'merge_msg_MatchDecideReq.Action'(Prev,
                                              New,
                                              TrUserData);
        'MatchDecideReq' ->
...
merge_msg_PlayerNewReq(#'PlayerNewReq'{color = PFcolor,
                                       symbol = PFsymbol},
                       #'PlayerNewReq'{name = NFname, color = NFcolor,
                                       symbol = NFsymbol, role = NFrole},
                       TrUserData) ->
    #'PlayerNewReq'{name = NFname,
                    color =
                        if PFcolor /= undefined, NFcolor /= undefined ->
                               'erlang_++'(PFcolor, NFcolor, TrUserData);
                           PFcolor == undefined -> NFcolor;
                           NFcolor == undefined -> PFcolor
                        end,
                    symbol =
                        if PFsymbol /= undefined, NFsymbol /= undefined ->
                               'erlang_++'(PFsymbol, NFsymbol, TrUserData);
                           PFsymbol == undefined -> NFsymbol;
                           NFsymbol == undefined -> PFsymbol
                        end,
                    role = NFrole}.
...
merge_msg_PlayerListResp(#'PlayerListResp'{players =
                                               PFplayers,
                                           error = PFerror},
                         #'PlayerListResp'{status = NFstatus,
                                           players = NFplayers,
                                           error = NFerror},
                         TrUserData) ->
    #'PlayerListResp'{status = NFstatus,
...
merge_msg_PlayerInfoResp(#'PlayerInfoResp'{flags =
                                               PFflags,
                                           inventory = PFinventory},
                         #'PlayerInfoResp'{name = NFname, health = NFhealth,
                                           energy = NFenergy, flags = NFflags,
    ...
    #'PlayerInfoResp'{name = NFname, health = NFhealth,
                      ...
                      inventory =
                          if PFinventory /= undefined,
                             NFinventory /= undefined ->
                                 'erlang_++'(PFinventory,
                                             NFinventory,
                                             TrUserData);
                             PFinventory == undefined -> NFinventory;
                             NFinventory == undefined -> PFinventory
                          end}.
...
merge_msg_MatchListResp(#'MatchListResp'{resp = PFresp,
                                         matches = PFmatches},
...
merge_msg_MatchCreateReq(#'MatchCreateReq'{extra =
                                               PFextra},
                         #'MatchCreateReq'{player = NFplayer, mode = NFmode,
                                           players_max = NFplayers_max,
                                           extra = NFextra},
                         _) ->
    #'MatchCreateReq'{player = NFplayer, mode = NFmode,
...
'merge_msg_MatchStateResp.Action'(#'MatchStateResp.Action'{},
                                  #'MatchStateResp.Action'{type = NFtype,
                                                           who = NFwho, x = NFx,
                                                           y = NFy},
                                  _) ->
    #'MatchStateResp.Action'{type = NFtype, who = NFwho,
                             x = NFx, y = NFy}.

-compile({nowarn_unused_function,merge_msg_MatchStateResp/3}).
merge_msg_MatchStateResp(#'MatchStateResp'{board =
                                               PFboard,
                                           playerlist = PFplayerlist,
                                           readyplayers = PFreadyplayers,
                                           replay = PFreplay, timer = PFtimer},
                         #'MatchStateResp'{state = NFstate, board = NFboard,
                                           playerlist = NFplayerlist,
                                           readyplayers = NFreadyplayers,
                                           replay = NFreplay, timer = NFtimer},
                         TrUserData) ->
    #'MatchStateResp'{state = NFstate,
                      board =
                          if PFboard /= undefined, NFboard /= undefined ->
                                 'erlang_++'(PFboard, NFboard, TrUserData);
                             PFboard == undefined -> NFboard;
                      ...
                      replay =
                          if PFreplay /= undefined, NFreplay /= undefined ->
                                 'erlang_++'(PFreplay, NFreplay, TrUserData);
                             PFreplay == undefined -> NFreplay;
                             NFreplay == undefined -> PFreplay
                          end,
                      timer =
...
'merge_msg_MatchDecideReq.Action'(#'MatchDecideReq.Action'{x
                                                               = PFx,
                                                           y = PFy,
                                                           target = PFtarget},
                                  #'MatchDecideReq.Action'{item = NFitem,
                                                           x = NFx, y = NFy,
                                                           target = NFtarget},
                                  _) ->
    #'MatchDecideReq.Action'{item = NFitem,
...
merge_msg_MatchDecideReq(#'MatchDecideReq'{actions =
                                               PFactions},
...
'merge_msg_MatchIntentResp.Action'(#'MatchIntentResp.Action'{x
                                                                 = PFx,
                                                             y = PFy,
                                                             target = PFtarget},
                                   #'MatchIntentResp.Action'{type = NFtype,
                                                             x = NFx, y = NFy,
                                                             target = NFtarget},
                                   _) ->
    #'MatchIntentResp.Action'{type = NFtype,
...
merge_msg_MatchIntentResp(#'MatchIntentResp'{action =
                                                 PFaction},
                          #'MatchIntentResp'{player = NFplayer,
                                             action = NFaction},
                          TrUserData) ->
    #'MatchIntentResp'{player = NFplayer,
                       action =
                           'merge_msg_MatchIntentResp.Action'(PFaction,
                                                              NFaction,
                                                              TrUserData)}.
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
        ...
        'MatchDecideReq.Action' ->
            'v_msg_MatchDecideReq.Action'(Msg,
                                          [MsgName],
                                          TrUserData);
        'MatchDecideReq' ->
        ...
        'MatchIntentResp.Action' ->
            'v_msg_MatchIntentResp.Action'(Msg,
                                           [MsgName],
                                           TrUserData);
        'MatchIntentResp' ->
...
v_msg_MatchInfo(#'MatchInfo'{id = F1, state = F2,
    ...
    if is_list(F3) ->
           _ = [v_type_string(Elem, [players | Path], TrUserData)
                || Elem <- F3],
           ok;
       true ->
...
v_msg_PlayerNewReq(#'PlayerNewReq'{name = F1,
    ...
    if is_list(F2) ->
           _ = [v_type_string(Elem, [color | Path], TrUserData)
                || Elem <- F2],
           ok;
       true ->
           mk_type_error({invalid_list_of, string},
    ...
    if is_list(F3) ->
           _ = [v_type_uint32(Elem, [symbol | Path], TrUserData)
                || Elem <- F3],
           ok;
       true ->
           mk_type_error({invalid_list_of, uint32},
                         F3,
                         [symbol | Path])
    end,
...
v_msg_PlayerListResp(#'PlayerListResp'{status = F1,
                                       players = F2, error = F3},
                     Path, TrUserData) ->
    'v_enum_PlayerListResp.Status'(F1,
                                   [status | Path],
                                   TrUserData),
    if is_list(F2) ->
           _ = [v_type_string(Elem, [players | Path], TrUserData)
...
v_msg_PlayerListResp(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'PlayerListResp'},
                  X,
                  Path).

-compile({nowarn_unused_function,v_msg_PlayerInfoResp/3}).
-dialyzer({nowarn_function,v_msg_PlayerInfoResp/3}).
v_msg_PlayerInfoResp(#'PlayerInfoResp'{name = F1,
                                       health = F2, energy = F3, flags = F4,
                                       inventory = F5},
                     Path, TrUserData) ->
    v_type_string(F1, [name | Path], TrUserData),
    ...
    if is_list(F5) ->
           _ = [v_type_string(Elem, [inventory | Path], TrUserData)
                || Elem <- F5],
           ok;
       true ->
           mk_type_error({invalid_list_of, string},
...
v_msg_PlayerInfoResp(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'PlayerInfoResp'},
                  X,
                  Path).
...
v_msg_MatchListResp(#'MatchListResp'{resp = F1,
                                     matches = F2},
                    Path, TrUserData) ->
...
v_msg_MatchCreateReq(#'MatchCreateReq'{player = F1,
                                       mode = F2, players_max = F3, extra = F4},
                     Path, TrUserData) ->
...
'v_msg_MatchStateResp.Action'(#'MatchStateResp.Action'{type
                                                           = F1,
                                                       who = F2, x = F3,
                                                       y = F4},
                              Path, TrUserData) ->
...
'v_msg_MatchDecideReq.Action'(#'MatchDecideReq.Action'{item
                                                           = F1,
                                                       x = F2, y = F3,
                                                       target = F4},
                              Path, TrUserData) ->
...
'v_msg_MatchDecideReq.Action'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'MatchDecideReq.Action'},
                  X,
                  Path).
...
v_msg_MatchDecideReq(#'MatchDecideReq'{player = F1,
    ...
    v_type_string(F1, [player | Path], TrUserData),
    if is_list(F2) ->
           _ = ['v_msg_MatchDecideReq.Action'(Elem,
                                              [actions | Path],
                                              TrUserData)
                || Elem <- F2],
           ok;
...
'v_msg_MatchIntentResp.Action'(#'MatchIntentResp.Action'{type
                                                             = F1,
                                                         x = F2, y = F3,
                                                         target = F4},
                               Path, TrUserData) ->
...
'v_msg_MatchIntentResp.Action'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'MatchIntentResp.Action'},
                  X,
                  Path).

-compile({nowarn_unused_function,v_msg_MatchIntentResp/3}).
-dialyzer({nowarn_function,v_msg_MatchIntentResp/3}).
v_msg_MatchIntentResp(#'MatchIntentResp'{player = F1,
                                         action = F2},
                      Path, TrUserData) ->
    v_type_string(F1, [player | Path], TrUserData),
    'v_msg_MatchIntentResp.Action'(F2,
                                   [action | Path],
                                   TrUserData),
    ok;
v_msg_MatchIntentResp(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'MatchIntentResp'},
                  X,
                  Path).
...
'v_enum_PlayerListResp.Status'('OK', _Path,
                               _TrUserData) ->
    ok;
'v_enum_PlayerListResp.Status'('ERROR', _Path,
                               _TrUserData) ->
    ok;
'v_enum_PlayerListResp.Status'(V, Path, TrUserData)
    when is_integer(V) ->
    v_type_sint32(V, Path, TrUserData);
'v_enum_PlayerListResp.Status'(X, Path, _TrUserData) ->
    mk_type_error({invalid_enum, 'PlayerListResp.Status'},
                  X,
                  Path).
    ...
    [{{enum, 'MatchState'},
     ...
     {{msg, 'PlayerNewReq'},
      [#field{name = name, fnum = 1, rnum = 2, type = string,
              occurrence = required, opts = []},
       #field{name = color, fnum = 2, rnum = 3, type = string,
              occurrence = repeated, opts = []},
       #field{name = symbol, fnum = 3, rnum = 4, type = uint32,
              occurrence = repeated, opts = []},
     ...
     {{msg, 'PlayerInfoResp'},
      [#field{name = name, fnum = 1, rnum = 2, type = string,
              occurrence = required, opts = []},
       #field{name = health, fnum = 2, rnum = 3, type = int32,
              occurrence = required, opts = []},
       #field{name = energy, fnum = 3, rnum = 4, type = int32,
              occurrence = required, opts = []},
       #field{name = flags, fnum = 4, rnum = 5, type = string,
              occurrence = repeated, opts = []},
       #field{name = inventory, fnum = 5, rnum = 6,
              type = string, occurrence = repeated, opts = []}]},
     ...
     {{msg, 'MatchCreateReq'},
      [#field{name = player, fnum = 1, rnum = 2,
       ...
       #field{name = mode, fnum = 2, rnum = 3,
              type = {enum, 'MatchMode'}, occurrence = required,
              opts = []},
       #field{name = players_max, fnum = 3, rnum = 4,
              type = uint32, occurrence = required, opts = []},
       #field{name = extra, fnum = 4, rnum = 5, type = bytes,
              occurrence = optional, opts = []}]},
     {{msg, 'MatchCreateResp'},
      [#field{name = resp, fnum = 1, rnum = 2,
              type = {msg, 'ResponseObject'}, occurrence = required,
     ...
     {{msg, 'MatchStateResp.Action'},
      [#field{name = type, fnum = 1, rnum = 2, type = string,
              occurrence = required, opts = []},
       #field{name = who, fnum = 2, rnum = 3, type = string,
              occurrence = required, opts = []},
       #field{name = x, fnum = 3, rnum = 4, type = int32,
              occurrence = required, opts = []},
       #field{name = y, fnum = 4, rnum = 5, type = int32,
              occurrence = required, opts = []}]},
     {{msg, 'MatchStateResp'},
      [#field{name = state, fnum = 1, rnum = 2,
              type = {enum, 'MatchStateMachine'},
              occurrence = required, opts = []},
       #field{name = board, fnum = 2, rnum = 3,
       ...
       #field{name = readyplayers, fnum = 4, rnum = 5,
              type = string, occurrence = repeated, opts = []},
       #field{name = replay, fnum = 5, rnum = 6,
              type = {msg, 'MatchStateResp.Action'},
              occurrence = repeated, opts = []},
       #field{name = timer, fnum = 6, rnum = 7, type = int32,
              occurrence = optional, opts = []}]},
     {{msg, 'MatchPrepReq'},
      [#field{name = player, fnum = 1, rnum = 2,
              type = string, occurrence = required, opts = []},
     ...
     {{msg, 'MatchDecideReq.Action'},
      [#field{name = item, fnum = 1, rnum = 2, type = string,
              occurrence = required, opts = []},
       #field{name = x, fnum = 2, rnum = 3, type = int32,
              occurrence = optional, opts = []},
       #field{name = y, fnum = 3, rnum = 4, type = int32,
              occurrence = optional, opts = []},
       #field{name = target, fnum = 4, rnum = 5, type = string,
              occurrence = optional, opts = []}]},
     {{msg, 'MatchDecideReq'},
      [#field{name = player, fnum = 1, rnum = 2,
              type = string, occurrence = required, opts = []},
     ...
     {{msg, 'MatchIntentResp'},
      [#field{name = player, fnum = 1, rnum = 2,
              type = string, occurrence = required, opts = []},
       #field{name = action, fnum = 2, rnum = 3,
...
'enum_value_by_symbol_PlayerListResp.Status'('ERROR') ->
    1.
...
fqbin_to_msg_name(<<"goblet.PlayerListResp">>) -> 'PlayerListResp';
fqbin_to_msg_name(<<"goblet.PlayerInfoResp">>) -> 'PlayerInfoResp';
fqbin_to_msg_name(<<"goblet.PlayerAuthenticate">>) -> 'PlayerAuthenticate';
fqbin_to_msg_name(<<"goblet.PlayerLog">>) -> 'PlayerLog';
fqbin_to_msg_name(<<"goblet.MatchListResp">>) -> 'MatchListResp';
...
fqbin_to_msg_name(<<"goblet.MatchDecideReq.Action">>) -> 'MatchDecideReq.Action';
fqbin_to_msg_name(<<"goblet.MatchDecideReq">>) -> 'MatchDecideReq';
fqbin_to_msg_name(<<"goblet.MatchDecideResp">>) -> 'MatchDecideResp';
fqbin_to_msg_name(<<"goblet.MatchIntentResp.Action">>) -> 'MatchIntentResp.Action';
fqbin_to_msg_name(<<"goblet.MatchIntentResp">>) -> 'MatchIntentResp';
...
msg_name_to_fqbin('PlayerListResp') -> <<"goblet.PlayerListResp">>;
msg_name_to_fqbin('PlayerInfoResp') -> <<"goblet.PlayerInfoResp">>;
msg_name_to_fqbin('PlayerAuthenticate') -> <<"goblet.PlayerAuthenticate">>;
msg_name_to_fqbin('PlayerLog') -> <<"goblet.PlayerLog">>;
msg_name_to_fqbin('MatchListResp') -> <<"goblet.MatchListResp">>;
...
msg_name_to_fqbin('MatchDecideReq.Action') -> <<"goblet.MatchDecideReq.Action">>;
msg_name_to_fqbin('MatchDecideReq') -> <<"goblet.MatchDecideReq">>;
msg_name_to_fqbin('MatchDecideResp') -> <<"goblet.MatchDecideResp">>;
msg_name_to_fqbin('MatchIntentResp.Action') -> <<"goblet.MatchIntentResp.Action">>;
msg_name_to_fqbin('MatchIntentResp') -> <<"goblet.MatchIntentResp">>;
...
fqbin_to_enum_name(<<"goblet.PlayerListResp.Status">>) -> 'PlayerListResp.Status';
...
enum_name_to_fqbin('PlayerListResp.Status') -> <<"goblet.PlayerListResp.Status">>;
...
get_proto_by_msg_name_as_fqbin(<<"goblet.PlayerListResp">>) -> "goblet";
get_proto_by_msg_name_as_fqbin(<<"goblet.PlayerInfoResp">>) -> "goblet";
...
get_proto_by_msg_name_as_fqbin(<<"goblet.MatchListResp">>) -> "goblet";
get_proto_by_msg_name_as_fqbin(<<"goblet.MatchLeaveResp">>) -> "goblet";
get_proto_by_msg_name_as_fqbin(<<"goblet.MatchJoinResp">>) -> "goblet";
get_proto_by_msg_name_as_fqbin(<<"goblet.MatchIntentResp">>) -> "goblet";
...
get_proto_by_msg_name_as_fqbin(<<"goblet.MatchIntentResp.Action">>) -> "goblet";
get_proto_by_msg_name_as_fqbin(<<"goblet.MatchDecideReq.Action">>) -> "goblet";
...
get_proto_by_enum_name_as_fqbin(<<"goblet.PlayerListResp.Status">>) -> "goblet";
