...
-export_type(['ResponseObject'/0, 'Match.Player'/0, 'Match'/0, 'AccountNewReq'/0, 'AccountNewResp'/0, 'AccountLoginReq'/0, 'AccountLoginResp.Player'/0, 'AccountLoginResp'/0, 'PlayerNewReq'/0, 'PlayerNewResp'/0, 'PlayerAuthenticate'/0, 'PlayerLog'/0, 'LobbyInfo'/0, 'MatchCreateReq'/0, 'MatchCreateResp'/0, 'MatchJoinReq'/0, 'MatchJoinResp'/0, 'MatchLeaveReq'/0, 'MatchLeaveResp'/0, 'MatchStartReq'/0, 'MatchStartResp'/0]).

-spec encode_msg(#'ResponseObject'{} | #'Match.Player'{} | #'Match'{} | #'AccountNewReq'{} | #'AccountNewResp'{} | #'AccountLoginReq'{} | #'AccountLoginResp.Player'{} | #'AccountLoginResp'{} | #'PlayerNewReq'{} | #'PlayerNewResp'{} | #'PlayerAuthenticate'{} | #'PlayerLog'{} | #'LobbyInfo'{} | #'MatchCreateReq'{} | #'MatchCreateResp'{} | #'MatchJoinReq'{} | #'MatchJoinResp'{} | #'MatchLeaveReq'{} | #'MatchLeaveResp'{} | #'MatchStartReq'{} | #'MatchStartResp'{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#'ResponseObject'{} | #'Match.Player'{} | #'Match'{} | #'AccountNewReq'{} | #'AccountNewResp'{} | #'AccountLoginReq'{} | #'AccountLoginResp.Player'{} | #'AccountLoginResp'{} | #'PlayerNewReq'{} | #'PlayerNewResp'{} | #'PlayerAuthenticate'{} | #'PlayerLog'{} | #'LobbyInfo'{} | #'MatchCreateReq'{} | #'MatchCreateResp'{} | #'MatchJoinReq'{} | #'MatchJoinResp'{} | #'MatchLeaveReq'{} | #'MatchLeaveResp'{} | #'MatchStartReq'{} | #'MatchStartResp'{}, atom() | list()) -> binary().
