...
fqbin_to_enum_name(<<"goblet.GenResponse.Status">>) -> 'GenResponse.Status';
fqbin_to_enum_name(E) ->
    error({gpb_error, {badenum, E}}).


enum_name_to_fqbin('GenResponse.Status') -> <<"goblet.GenResponse.Status">>;
...
get_proto_by_enum_name_as_fqbin(<<"goblet.GenResponse.Status">>) -> "goblet";
